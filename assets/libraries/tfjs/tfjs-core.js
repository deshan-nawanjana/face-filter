 ...
 */
 !function(e, t) {
    ...
    function x(e, t) {
        var n = t.length;
        return p((e = null == e ? t.map((function(e, t) {
            return t
        }
    ...
    function E(e, t) {
        for (var n = [], r = [], a = null != t && Array.isArray(t) && 0 === t.length, i = null == t || a ? null : x(t, e).sort(), o = 0, s = 0; s < e.length; ++s) {
            if (null != i) {
                if (i[o] === s && 1 !== e[s])
    ...
    function F(e) {
        return Array.isArray(e) ? F(e[0]) : e instanceof Float32Array ? "float32" : e instanceof Int32Array || e instanceof Uint8Array || e instanceof Uint8ClampedArray ? "int32" : B(e) ? "float32" : D(e) ? "string" : R(e) ? "bool" : "float32"
    }
    function C(e) {
    ...
    function K(e, t) {
        for (var n = q(e, t), r = 0; r < n.length; r++)
            n[r] = 1;
        return n
    }
    function q(e, t) {
    ...
    function W(e) {
        e.forEach((function(t) {
            p(Number.isInteger(t) && t >= 0, (function() {
    ...
    var U, V = "tfjsflags", H = function() {
        ...
        return e.prototype.setPlatform = function(e, t) {
            null != this.platform && (Z().getBool("IS_TEST") || Z().getBool("PROD") || console.warn("Platform " + this.platformName + " has already been set. Overwriting the platform with " + e + ".")),
            this.platformName = e,
            this.platform = t
        }
        ,
        e.prototype.registerFlag = function(e, t, n) {
            ...
            null != this.urlFlags[e]) {
                ...
                Z().getBool("IS_TEST") || Z().getBool("PROD") || console.warn("Setting feature override from URL " + e + ": " + r + "."),
                this.set(e, r)
            }
        }
        ,
    ...
    function X(e, t) {
        var n, r = (null == (n = Y())._tfGlobals && (n._tfGlobals = new Map),
        n._tfGlobals);
        if (r.has(e))
            return r.get(e);
        var a = t();
    ...
    var Q = "Acos"
      ...
      , we = "Concat"
      , ke = "Conv2D"
      , xe = "Conv2DBackpropFilter"
      , Ee = "Conv2DBackpropInput"
      , Se = "Conv3D"
      , Ae = "Conv3DBackpropInputV2"
      , _e = "Cosh"
      , Ie = "Cumprod"
      , Ne = "Cumsum"
      , Me = "CropAndResize"
      , Te = "DenseBincount"
      , De = "DepthToSpace"
      , Re = "DepthwiseConv2dNative"
      , Be = "DepthwiseConv2dNativeBackpropFilter"
      , Fe = "DepthwiseConv2dNativeBackpropInput"
      , Ce = "Diag"
      , Pe = "Dilation2D"
      , Oe = "RealDiv"
      , Le = "Einsum"
      ...
      , bt = "Multiply"
      , wt = "NotEqual"
      , kt = "NonMaxSuppressionV3"
      , xt = "NonMaxSuppressionV4"
      ...
      , Xt = "SplitV"
      , Qt = "Softmax"
      , $t = "SparseFillEmptyRows"
      , en = "SparseReshape"
      , tn = "SparseSegmentMean"
      , nn = "SparseSegmentSum"
      , rn = "SparseToDense"
      , an = "SquaredDifference"
      , on = "StridedSlice"
      , sn = "StringNGrams"
      , un = "StringSplit"
      ...
      , xn = "_FusedMatMul"
      , En = "FusedConv2D"
      , Sn = "FusedDepthwiseConv2D";
    function An() {
        for (var e = [], t = 0; t < arguments.length; t++)
            e[t] = arguments[t];
        Z().getBool("IS_TEST") || Z().getBool("PROD") || console.warn.apply(console, s(e))
    }
    var _n = X("kernelRegistry", (function() {
        return new Map
    }
    ))
      , In = X("gradRegistry", (function() {
        return new Map
    }
    ));
    function Nn(e, t) {
    ...
    function Dn(e) {
        var t = e.kernelName
          , n = e.backendName
          , r = Rn(t, n);
        _n.has(r) && An("The kernel '" + t + "' for backend '" + n + "' is already registered"),
        _n.set(r, e)
    }
    function Rn(e, t) {
        return t + "_" + e
    ...
    Cn.prototype.__isLong__,
    Object.defineProperty(Cn.prototype, "__isLong__", {
        value: !0
    }),
    Cn.isLong = Pn;
    var On = {}
    ...
    function zn(e, t) {
        var n, r, a;
        return t ? (a = 0 <= (e >>>= 0) && e < 256) && (r = Ln[e]) ? r : (n = qn(e, (0 | e) < 0 ? -1 : 0, !0),
        a && (Ln[e] = n),
        n) : (a = -128 <= (e |= 0) && e < 128) && (r = On[e]) ? r : (n = qn(e, e < 0 ? -1 : 0, !1),
        a && (On[e] = n),
        n)
    }
    function Kn(e, t) {
        ...
        return e < 0 ? Kn(-e, t).neg() : qn(e % Vn | 0, e / Vn | 0, t)
    }
    function qn(e, t, n) {
        return new Cn(e,t,n)
    }
    ...
    function Gn(e, t, n) {
        ...
        if (0 === r)
            return Gn(e.substring(1), t, n).neg();
        for (var a = Kn(Wn(n, 8)), i = Zn, o = 0; o < e.length; o += 8) {
            ...
            if (s < 8) {
                ...
                i = (i = i.mul(a)).add(Kn(u))
        }
        return i.unsigned = t,
        i
    }
    function Un(e, t) {
        return "number" == typeof e ? Kn(e, t) : "string" == typeof e ? Gn(e, t) : qn(e.low, e.high, "boolean" == typeof t ? t : e.unsigned)
    }
    Cn.fromString = Gn,
    Cn.fromValue = Un;
    var Vn = 4294967296
    ...
    var $n = zn(-1);
    Cn.NEG_ONE = $n;
    var er = qn(-1, 2147483647, !1);
    Cn.MAX_VALUE = er;
    var tr = qn(-1, -1, !0);
    Cn.MAX_UNSIGNED_VALUE = tr;
    var nr = qn(0, -2147483648, !1);
    Cn.MIN_VALUE = nr;
    var rr = Cn.prototype;
    rr.toInt = function() {
    ...
    ,
    rr.toNumber = function() {
        return this.unsigned ? (this.high >>> 0) * Vn + (this.low >>> 0) : this.high * Vn + (this.low >>> 0)
    }
    ,
    rr.toString = function(e) {
        ...
        for (var a = Kn(Wn(e, 6), this.unsigned), i = this, o = ""; ; ) {
            var s = i.div(a)
    ...
    ,
    rr.getHighBits = function() {
        return this.high
    }
    ,
    rr.getHighBitsUnsigned = function() {
        return this.high >>> 0
    }
    ,
    rr.getLowBits = function() {
        return this.low
    }
    ,
    rr.getLowBitsUnsigned = function() {
        return this.low >>> 0
    }
    ,
    rr.getNumBitsAbs = function() {
        if (this.isNegative())
            return this.eq(nr) ? 64 : this.neg().getNumBitsAbs();
    ...
    ,
    rr.eqz = rr.isZero,
    rr.isNegative = function() {
        return !this.unsigned && this.high < 0
    }
    ,
    rr.isPositive = function() {
        return this.unsigned || this.high >= 0
    }
    ,
    rr.isOdd = function() {
    ...
    ,
    rr.equals = function(e) {
        return Pn(e) || (e = Un(e)),
        (this.unsigned === e.unsigned || this.high >>> 31 != 1 || e.high >>> 31 != 1) && (this.high === e.high && this.low === e.low)
    }
    ,
    rr.eq = rr.equals,
    rr.notEquals = function(e) {
        return !this.eq(e)
    }
    ,
    rr.neq = rr.notEquals,
    rr.ne = rr.notEquals,
    rr.lessThan = function(e) {
        return this.comp(e) < 0
    }
    ,
    rr.lt = rr.lessThan,
    rr.lessThanOrEqual = function(e) {
        return this.comp(e) <= 0
    }
    ,
    rr.lte = rr.lessThanOrEqual,
    rr.le = rr.lessThanOrEqual,
    rr.greaterThan = function(e) {
        return this.comp(e) > 0
    }
    ,
    rr.gt = rr.greaterThan,
    rr.greaterThanOrEqual = function(e) {
        return this.comp(e) >= 0
    }
    ,
    rr.gte = rr.greaterThanOrEqual,
    rr.ge = rr.greaterThanOrEqual,
    rr.compare = function(e) {
        if (Pn(e) || (e = Un(e)),
        this.eq(e))
            return 0;
    ...
    rr.comp = rr.compare,
    rr.negate = function() {
        return !this.unsigned && this.eq(nr) ? nr : this.not().add(Xn)
    }
    ,
    rr.neg = rr.negate,
    rr.add = function(e) {
        ...
        u += (l += n + o) >>> 16,
        u += t + i,
        qn((c &= 65535) << 16 | (h &= 65535), (u &= 65535) << 16 | (l &= 65535), this.unsigned)
    }
    ,
    rr.subtract = function(e) {
        return Pn(e) || (e = Un(e)),
        this.add(e.neg())
    }
    ,
    rr.sub = rr.subtract,
    rr.multiply = function(e) {
        if (this.isZero())
            return Zn;
        if (Pn(e) || (e = Un(e)),
        Fn)
            return qn(Fn.mul(this.low, this.high, e.low, e.high), Fn.get_high(), this.unsigned);
        if (e.isZero())
            return Zn;
        if (this.eq(nr))
            return e.isOdd() ? nr : Zn;
        if (e.eq(nr))
            return this.isOdd() ? nr : Zn;
        if (this.isNegative())
            return e.isNegative() ? this.neg().mul(e.neg()) : this.neg().mul(e).neg();
        if (e.isNegative())
            return this.mul(e.neg()).neg();
        if (this.lt(Jn) && e.lt(Jn))
            return Kn(this.toNumber() * e.toNumber(), this.unsigned);
        var t = this.high >>> 16
          , n = 65535 & this.high
          , r = this.low >>> 16
          , a = 65535 & this.low
        ...
        l += (c += a * o) >>> 16,
        l += t * u + n * s + r * o + a * i,
        qn((h &= 65535) << 16 | (f &= 65535), (l &= 65535) << 16 | (c &= 65535), this.unsigned)
    }
    ,
    rr.mul = rr.multiply,
    rr.divide = function(e) {
        if (Pn(e) || (e = Un(e)),
        e.isZero())
            throw Error("division by zero");
        var t, n, r;
        if (Fn)
            return this.unsigned || -2147483648 !== this.high || -1 !== e.low || -1 !== e.high ? qn((this.unsigned ? Fn.div_u : Fn.div_s)(this.low, this.high, e.low, e.high), Fn.get_high(), this.unsigned) : this;
        if (this.isZero())
            return this.unsigned ? Yn : Zn;
        if (this.unsigned) {
            ...
            if (this.eq(nr))
                return e.eq(Xn) || e.eq($n) ? nr : e.eq(nr) ? Xn : (t = this.shr(1).div(e).shl(1)).eq(Zn) ? e.isNegative() ? Xn : $n : (n = this.sub(e.mul(t)),
                r = t.add(n.div(e)));
            if (e.eq(nr))
                return this.unsigned ? Yn : Zn;
            if (this.isNegative())
        ...
        for (n = this; n.gte(e); ) {
            ...
            for (var a = Math.ceil(Math.log(t) / Math.LN2), i = a <= 48 ? 1 : Wn(2, a - 48), o = Kn(t), s = o.mul(e); s.isNegative() || s.gt(n); )
                s = (o = Kn(t -= i, this.unsigned)).mul(e);
            o.isZero() && (o = Xn),
            r = r.add(o),
            n = n.sub(s)
        }
    ...
    ,
    rr.div = rr.divide,
    rr.modulo = function(e) {
        return Pn(e) || (e = Un(e)),
        Fn ? qn((this.unsigned ? Fn.rem_u : Fn.rem_s)(this.low, this.high, e.low, e.high), Fn.get_high(), this.unsigned) : this.sub(this.div(e).mul(e))
    }
    ,
    rr.mod = rr.modulo,
    rr.rem = rr.modulo,
    ...
    ,
    rr.shiftLeft = function(e) {
        return Pn(e) && (e = e.toInt()),
        0 == (e &= 63) ? this : e < 32 ? qn(this.low << e, this.high << e | this.low >>> 32 - e, this.unsigned) : qn(0, this.low << e - 32, this.unsigned)
    }
    ,
    rr.shl = rr.shiftLeft,
    rr.shiftRight = function(e) {
        return Pn(e) && (e = e.toInt()),
        0 == (e &= 63) ? this : e < 32 ? qn(this.low >>> e | this.high << 32 - e, this.high >> e, this.unsigned) : qn(this.high >> e - 32, this.high >= 0 ? 0 : -1, this.unsigned)
    }
    ,
    rr.shr = rr.shiftRight,
    rr.shiftRightUnsigned = function(e) {
        if (Pn(e) && (e = e.toInt()),
        0 === (e &= 63))
            return this;
        var t = this.high;
    ...
    ,
    rr.shru = rr.shiftRightUnsigned,
    rr.shr_u = rr.shiftRightUnsigned,
    rr.toSigned = function() {
        return this.unsigned ? qn(this.low, this.high, !1) : this
    }
    ,
    rr.toUnsigned = function() {
        return this.unsigned ? this : qn(this.low, this.high, !0)
    }
    ,
    rr.toBytes = function(e) {
        return e ? this.toBytesLE() : this.toBytesBE()
    }
    ,
    rr.toBytesLE = function() {
        var e = this.high
          , t = this.low;
        return [255 & t, t >>> 8 & 255, t >>> 16 & 255, t >>> 24, 255 & e, e >>> 8 & 255, e >>> 16 & 255, e >>> 24]
    }
    ,
    rr.toBytesBE = function() {
        var e = this.high
          , t = this.low;
        return [e >>> 24, e >>> 16 & 255, e >>> 8 & 255, 255 & e, t >>> 24, t >>> 16 & 255, t >>> 8 & 255, 255 & t]
    }
    ,
    Cn.fromBytes = function(e, t, n) {
        return n ? Cn.fromBytesLE(e, t) : Cn.fromBytesBE(e, t)
    }
    ,
    Cn.fromBytesLE = function(e, t) {
        return new Cn(e[0] | e[1] << 8 | e[2] << 16 | e[3] << 24,e[4] | e[5] << 8 | e[6] << 16 | e[7] << 24,t)
    }
    ,
    Cn.fromBytesBE = function(e, t) {
        return new Cn(e[4] << 24 | e[5] << 16 | e[6] << 8 | e[7],e[0] << 24 | e[1] << 16 | e[2] << 8 | e[3],t)
    }
    ;
    var ar = Bn || Object.assign(Object.create(null), Bn, {
        default: Bn
    });
    function ir(e) {
        return ar.fromString(e, !0, 16)
    }
    var or = ir("c3a5c85c97cb3127")
      , sr = ir("b492b66fbe98f273")
      , ur = ir("9ae16a3b2f90404f");
    function lr(e) {
        return e.xor(e.shru(47))
    }
    function cr(e, t, n) {
        var r = e.slice(t, t + n);
        return ar.fromBytes(Array.from(r), !0, !0)
    }
    function hr(e, t) {
        return cr(e, t, 8)
    }
    ...
    function pr(e, t, n) {
        void 0 === n && (n = ir("9ddfea08eb382d69"));
        var r = e.xor(t).mul(n);
        r = r.xor(r.shru(47));
        var a = t.xor(r).mul(n);
    ...
    function vr(e, t, n, r) {
        return function(e, t, n, r, a, i) {
            a = a.add(e),
            i = dr(i.add(a).add(r), 21);
            var o = a;
            return a = (a = a.add(t)).add(n),
            i = i.add(dr(a, 44)),
            [a.add(r), i.add(o)]
        }(hr(e, t), hr(e, t + 8), hr(e, t + 16), hr(e, t + 24), n, r)
    }
    function gr(e, t) {
        if ("string" === t)
            throw new Error("Cannot convert a string[] to a TypedArray");
        if (Array.isArray(e) && (e = m(e)),
        Z().getBool("DEBUG") && _(e, t),
        function(e, t) {
    ...
    var wr = {
        ...
        makeZerosNestedTypedArray: function(e, t) {
            ...
            if (null == t || "float32" === t)
                return z(e, new Float32Array(n));
            if ("int32" === t)
                return z(e, new Int32Array(n));
            if ("bool" === t)
                return z(e, new Uint8Array(n));
            throw new Error("Unknown data type " + t)
        },
        assertNonNegativeIntegerDimensions: W,
            ...
            if (t <= 32)
                return t <= 16 ? function(e, t) {
                    ...
                    t >= 8) {
                        var n = ur.add(2 * t)
                          , r = hr(e, 0).add(ur);
                        return pr(dr(a = hr(e, t - 8), 37).mul(n).add(r), dr(r, 25).add(a).mul(n), n)
                    }
                    if (t >= 4)
                        return n = ur.add(2 * t),
                        pr((r = fr(e, 0)).shl(3).add(t), fr(e, t - 4), n);
                    if (t > 0) {
                        var a, i = (r = e[0]) + ((a = e[t >> 1]) << 8), o = t + (e[t - 1] << 2);
                        return lr(ur.mul(i).xor(or.mul(o))).mul(ur)
                    }
                    return ur
                }(e, t) : function(e, t) {
                    void 0 === t && (t = e.length);
                    var n = ur.add(2 * t)
                      ...
                      , i = hr(e, t - 8).mul(n)
                      , o = hr(e, t - 16).mul(ur);
                    return pr(dr(r.add(a), 43).add(dr(i, 30)).add(o), r.add(dr(a.add(ur), 18)).add(i), n)
                }(e, t);
            if (t <= 64)
                return function(e, t) {
                    void 0 === t && (t = e.length);
                    var n = ur.add(2 * t)
                      ...
                      , i = hr(e, t - 8).mul(n)
                      , o = hr(e, t - 16).mul(ur)
                      , s = dr(r.add(a), 43).add(dr(i, 30)).add(o)
                      , u = pr(s, r.add(dr(a.add(ur), 18)).add(i), n)
                      , l = hr(e, 16).mul(n)
                      , c = hr(e, 24)
                      , h = s.add(hr(e, t - 32)).mul(n)
                      , f = u.add(hr(e, t - 24)).mul(n);
                    return pr(dr(l.add(c), 43).add(dr(h, 30)).add(f), l.add(dr(c.add(r), 18)).add(h), n)
                }(e, t);
            var i = a
              , s = a.mul(sr).add(113)
              , u = lr(s.mul(ur).add(113)).mul(ur)
              , l = [ar.UZERO, ar.UZERO]
              , c = [ar.UZERO, ar.UZERO];
            i = i.mul(ur).add(hr(e, 0));
            var h = 0
              , f = 64 * (t - 1 >> 6)
              , d = f + (t - 1 & 63) - 63;
            do {
                i = dr(i.add(s).add(l[0]).add(hr(e, h + 8)), 37).mul(sr),
                s = dr(s.add(l[1]).add(hr(e, h + 48)), 42).mul(sr),
                i = i.xor(c[1]),
                s = s.add(l[0]).add(hr(e, h + 40)),
                u = dr(u.add(c[0]), 33).mul(sr),
                l = vr(e, h, l[1].mul(sr), i.add(c[0])),
                c = vr(e, h + 32, u.add(c[1]), s.add(hr(e, h + 16))),
                u = (n = o([i, u], 2))[0],
                i = n[1],
                h += 64
            } while (h !== f);
            var p = sr.add(u.and(255).shl(1));
            return h = d,
            c[0] = c[0].add(t - 1 & 63),
            l[0] = l[0].add(c[0]),
            c[0] = c[0].add(l[0]),
            i = dr(i.add(s).add(l[0]).add(hr(e, h + 8)), 37).mul(p),
            s = dr(s.add(l[1]).add(hr(e, h + 48)), 42).mul(p),
            i = i.xor(c[1].mul(9)),
            s = s.add(l[0].mul(9).add(hr(e, h + 40))),
            u = dr(u.add(c[0]), 33).mul(p),
            l = vr(e, h, l[1].mul(p), i.add(c[0])),
            c = vr(e, h + 32, u.add(c[1]), s.add(hr(e, h + 16))),
            u = (r = o([i, u], 2))[0],
            i = r[1],
            pr(pr(l[0], c[0], p).add(lr(s).mul(or)).add(u), pr(l[1], c[1], p).add(i), p)
        }
    }
      , kr = function() {
        function e(e, t) {
        ...
        return e.prototype.profileKernel = function(e, t, n) {
            ...
            if (this.backendTimer.timerAvailable())
                s = this.backendTimer.time(u);
            else {
                u();
                try {
                    for (var c = i(o), h = c.next(); !h.done; h = c.next()) {
                        h.value.dataSync()
                    }
                } catch (e) {
                    r = {
    ...
    var xr = function() {
        ...
        return e.prototype.logKernelProfile = function(e, t, n, r, a, i) {
            var o = "number" == typeof r ? k(r + "ms", 9) : r.error
              , s = k(e, 25)
              , u = t.rank
              , l = t.size
              , c = k(t.shape.toString(), 14)
              , h = "";
            for (var f in a) {
                var d = a[f];
                if (null != d) {
        ...
        var a = O(t)
          , i = function(e, t, n, r) {
            var a = y(t)
              ...
              , s = t.length
              , u = "complex64" === n ? Ir(e) : e;
            if (s > 1)
                for (var l = 0; l < a / i; l++)
                    for (var c = l * i, h = 0; h < i; h++)
                        o[h] = Math.max(o[h], Sr(u[c + h], 0, n).length);
            return o
        }(e, t, n, a)
          , o = t.length
          , s = _r(e, t, n, a, i)
    ...
    function Sr(e, t, n) {
        return k(Array.isArray(e) ? parseFloat(e[0].toFixed(7)) + " + " + parseFloat(e[1].toFixed(7)) + "j" : D(e) ? "'" + e + "'" : "bool" === n ? Ar(e) : parseFloat(e.toFixed(7)).toString(), t)
    }
    function Ar(e) {
    ...
    function _r(e, t, n, r, a, i) {
        ...
        var o = "complex64" === n ? 2 : 1
          ...
          , l = t.length;
        if (0 === l)
            return "complex64" === n ? [Sr(Ir(e)[0], 0, n)] : "bool" === n ? [Ar(e[0])] : [e[0].toString()];
        if (1 === l) {
            if (u > 20) {
                var c = 3 * o
                  , h = Array.from(e.slice(0, c))
                  , f = Array.from(e.slice((u - 3) * o, u * o));
                return "complex64" === n && (h = Ir(h),
                f = Ir(f)),
                ["[" + h.map((function(e, t) {
                    return Sr(e, a[t], n)
                }
                )).join(", ") + ", ..., " + f.map((function(e, t) {
                    return Sr(e, a[u - 3 + t], n)
                }
                )).join(", ") + "]"]
            }
            return ["[" + ("complex64" === n ? Ir(e) : Array.from(e)).map((function(e, t) {
                return Sr(e, a[t], n)
            }
            )).join(", ") + "]"]
        }
        ...
        if (u > 20) {
            for (var m = 0; m < 3; m++) {
                var y = (b = m * v) + v;
                g.push.apply(g, s(_r(e.slice(b, y), d, n, p, a, !1)))
            }
            g.push("...");
            for (m = u - 3; m < u; m++) {
                y = (b = m * v) + v;
                g.push.apply(g, s(_r(e.slice(b, y), d, n, p, a, m === u - 1)))
            }
        } else
            for (m = 0; m < u; m++) {
                var b;
    ...
    var Nr = function() {
        ...
        e.prototype.toTensor = function() {
            return Mr().makeTensor(this.values, this.shape, this.dtype)
        }
        ,
        e
    }()
    ...
    var Dr = function() {
        ...
        e.prototype.buffer = function() {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(t) {
                    ...
                    case 1:
                        return e = t.sent(),
                        [2, Tr.buffer(this.shape, this.dtype, e)]
                    }
                }
                ))
            }
        ...
        e.prototype.bufferSync = function() {
            return Tr.buffer(this.shape, this.dtype, this.dataSync())
        }
        ,
        ...
        e.prototype.dataToGPU = function(e) {
            return this.throwIfDisposed(),
            Mr().readToGPU(this.dataId, e)
        }
        ,
        e.prototype.dataSync = function() {
            this.throwIfDisposed();
            var e = Mr().readSync(this.dataId);
        ...
        ,
        e.prototype.dispose = function() {
            this.isDisposed || (Mr().disposeTensor(this),
        ...
        e.prototype.toString = function(e) {
            return void 0 === e && (e = !1),
            Er(this.dataSync(), this.shape, this.dtype, e)
        }
        ,
        ...
        e.prototype.variable = function(e, t, n) {
            return void 0 === e && (e = !0),
            this.throwIfDisposed(),
            Mr().makeVariable(this, e, t, n)
        }
        ,
        e
    }();
    Object.defineProperty(Dr, Symbol.hasInstance, {
        value: function(e) {
    ...
    var Rr, Br, Fr, Cr, Pr, Or = function(e) {
        function t(t, n, r, a) {
        ...
        t.prototype.assign = function(e) {
            ...
            Mr().disposeTensor(this),
            this.dataId = e.dataId,
            Mr().incRef(this, null)
        }
        ,
        t.prototype.dispose = function() {
            Mr().disposeVariable(this),
            this.isDisposedInternal = !0
        }
        ,
        t
    ...
    Object.defineProperty(Or, Symbol.hasInstance, {
        value: function(e) {
            return e instanceof Dr && null != e.assign && e.assign instanceof Function
        }
    }),
    e.Rank = void 0,
    (Rr = e.Rank || (e.Rank = {})).R0 = "R0",
    Rr.R1 = "R1",
    Rr.R2 = "R2",
    Rr.R3 = "R3",
    Rr.R4 = "R4",
    ...
    function Kr(e, t) {
        if (e.dtype === t.dtype)
            return [e, t];
        var n = zr(e.dtype, t.dtype);
        return [e.cast(n), t.cast(n)]
    }
    function qr(e, t) {
        p(e.dtype === t.dtype, (function() {
    ...
    var Hr = function() {
      ...
      , jr = function() {
        ...
        e.prototype.registerBackend = function(e, t, n) {
            return void 0 === n && (n = 1),
            e in this.registryFactory ? (An(e + " backend was already registered. Reusing existing backend factory."),
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    case 4:
                        ...
                        this.profiler = new kr(this.backendInstance),
                        [2, !0]
                    }
                }
                ))
        ...
        e.prototype.setupRegisteredKernels = function() {
            var e = this;
            Tn(this.backendName).forEach((function(t) {
            ...
            try {
                ...
                var a = ++this.pendingBackendInitId
                  , i = r.then((function(n) {
                    ...
                    An("Initialization of backend " + e + " failed"),
                    An(n.stack || n.message)),
                    !1
                }
                ));
                ...
                return An("Initialization of backend " + e + " failed"),
                An(t.stack || t.message),
                {
                    success: !1,
                    asyncInit: !1
                }
        ...
        e.prototype.runKernelFunc = function(e) {
            ...
            var l = Vr(e) ? e.kernelName : null != this.state.activeScope ? this.state.activeScope.name : "";
            if (Vr(e)) {
                var c = e.kernelName
                  , h = e.inputs
                  , f = e.attrs;
                null == this.backendName && this.backend;
                var d = Nn(c, this.backendName);
                p(null != d, (function() {
            ...
            var m, y = e.inputs, b = e.attrs, w = Vr(e) ? null : e.backwardsFunc;
            return this.scopedRun((function() {
                ...
                a.ENV.getBool("DEBUG") || a.state.profiling ? (m = a.profiler.profileKernel(l, y, (function() {
                    return n()
                }
                )),
        ...
        e.prototype.getTensorsForGradient = function(e, t, n) {
            ...
            if (null != r) {
                var a = r.inputsToSave || []
                  , i = r.outputsToSave || []
                  , o = void 0;
                r.saveAllInputs ? (p(Array.isArray(t), (function() {
        ...
        e.prototype.makeTensor = function(e, t, n, r) {
            ...
            var i = r.write(a, t, n)
              , o = new Dr(t,n,i,this.nextTensorId());
        ...
        e.prototype.makeTensorFromDataId = function(e, t, n, r) {
            var a = new Dr(t,n = n || "float32",e,this.nextTensorId());
        ...
        e.prototype.makeVariable = function(e, t, n, r) {
            ...
            var a = new Or(e,t,n,this.nextTensorId());
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    case 1:
                        ...
                        this.state.activeProfile.peakBytes = Math.max.apply(Math, s(this.state.activeProfile.kernels.map((function(e) {
                        ...
                        a.label = 2;
                    case 2:
                        a.trys.push([2, 8, 9, 10]),
                        o = i(this.state.activeProfile.kernels),
                        u = o.next(),
                        a.label = 3;
                    case 3:
                        return u.done ? [3, 7] : (l = u.value,
                        c = l,
                        [4, l.kernelTimeMs]);
                    case 4:
                        return c.kernelTimeMs = a.sent(),
                        h = l,
                        [4, l.extraInfo];
                    case 5:
                        h.extraInfo = a.sent(),
        ...
        e.prototype.endScope = function(e) {
            for (var t = this, n = Wr(e), r = new Set(n.map((function(e) {
                return e.id
            }
        ...
        e.prototype.gradients = function(e, t, n, r) {
            ...
            return this.tidy("backward", (function() {
                var e, r, u = {};
                u[o.id] = null == n ? (e = o.shape,
                r = K(y(e), "float32"),
                Yr.makeTensor(r, e, "float32")) : n,
                function(e, t, n, r) {
        ...
        e.prototype.customGrad = function(e) {
            ...
            function() {
                ...
                var o = function(t, a) {
                    return p((n = e.apply(void 0, s(r, [a]))).value instanceof Dr, (function() {
                        return "The function f passed in customGrad(f) must return an object where `obj.value` is a tensor"
                    }
                    )),
                    p(C(n.gradFunc), (function() {
                  ...
                  , u = function(e, t) {
                    ...
                    p(i.length === r.length, (function() {
                        return "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function that returns the same number of tensors as inputs passed to f(...)."
                    }
                    )),
                    p(i.every((function(e) {
                        return e instanceof Dr
                    }
                    )), (function() {
    ...
    function ta(e, t) {
        ...
        if (!Array.isArray(e))
            return [];
        for (var r = []; Array.isArray(n) || N(n) && "string" !== t; )
            r.push(n.length),
            n = n[0];
        return Array.isArray(e) && Z().getBool("TENSORLIKE_CHECK_SHAPE_CONSISTENCY") && na(e, r, []),
        r
    }
    function na(e, t, n) {
        if (n = n || [],
    ...
    function aa(e, t, n, r) {
        ...
        e instanceof Dr)
            return ra(r, e.dtype, t, n),
            e;
        var a = F(e);
        if ("string" !== a && ["bool", "int32", "float32"].indexOf(r) >= 0 && (a = r),
        ra(r, a, t, n),
        null == e || !N(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e && "string" != typeof e) {
        ...
        var s = "string" !== a ? gr(e, a) : m(e, [], !0);
        return Yr.makeTensor(s, o, a)
    }
    function ia(e, t, n, r) {
        if (void 0 === r && (r = "numeric"),
        !Array.isArray(e))
    ...
    ea.registerFlag("DEBUG", (function() {
        return !1
    }
    ), (function(e) {
    ...
    ea.registerFlag("IS_BROWSER", (function() {
        return Qr()
    }
    )),
    ea.registerFlag("IS_NODE", (function() {
        return "undefined" != typeof process && "undefined" != typeof process.versions && "undefined" != typeof process.versions.node
    }
    )),
    ea.registerFlag("IS_CHROME", (function() {
        return "undefined" != typeof navigator && null != navigator && null != navigator.userAgent && /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator.vendor)
    }
    )),
    ea.registerFlag("PROD", (function() {
        return !1
    }
    )),
    ea.registerFlag("TENSORLIKE_CHECK_SHAPE_CONSISTENCY", (function() {
        return ea.getBool("DEBUG")
    }
    )),
    ea.registerFlag("DEPRECATION_WARNINGS_ENABLED", (function() {
        return !0
    }
    )),
    ea.registerFlag("IS_TEST", (function() {
        return !1
    }
    )),
    ea.registerFlag("CHECK_COMPUTATION_FOR_ERRORS", (function() {
        return !0
    }
    )),
    ea.registerFlag("WRAP_TO_IMAGEBITMAP", (function() {
        return !1
    }
    )),
    ea.registerFlag("ENGINE_COMPILE_ONLY", (function() {
        return !1
    }
    ));
    var oa = "__op";
    function sa(e) {
        ...
        var a = function() {
            ...
            Yr.startScope(n);
            try {
                var a = r.apply(void 0, s(e));
                return G(a) && console.error("Cannot return a Promise inside of tidy."),
                Yr.endScope(a),
                a
            } catch (e) {
                throw Yr.endScope(null),
                e
            }
        };
    ...
    function la(e, t, n, r) {
        ...
        if (!N(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e && "string" != typeof e)
        ...
        if (null != t) {
            ...
            for (var o = 0; o < n.length; ++o) {
                var s = n[o]
                  , u = o !== n.length - 1 || s !== y(t.slice(o));
                p(n[o] === t[o] || !u, (function() {
                    return "Error creating a new Tensor. Inferred shape (" + n + ") does not match the provided shape (" + t + "). "
                }
                ))
            }
        }
        return N(e) || Array.isArray(e) || (e = [e]),
        t = t || n,
        e = "string" !== r ? gr(e, r) : m(e, [], !0),
        Yr.makeTensor(e, t, r)
    }
    function ca(e, t, n) {
        return la(e, t, ta(e, n), n)
    }
    var ha = {
        float32: 4,
        float16: 2,
    ...
    function fa(e, t) {
        var n, r, a, o = {}, s = 0;
        try {
            for (var u = i(t), l = u.next(); !l.done; l = u.next()) {
                var c = l.value
                  , h = c.name
                  , f = c.dtype
                  , d = c.shape
                ...
                if ("quantization"in c) {
                    ...
                    var m = ha[g.dtype]
                      , b = e.slice(s, s + p * m)
                      , w = "uint8" === g.dtype ? new Uint8Array(b) : new Uint16Array(b);
                    if ("float32" === f)
                        if ("uint8" === g.dtype || "uint16" === g.dtype) {
                            v = new Float32Array(w.length);
                        ...
                        v = new Int32Array(w.length);
                        for (k = 0; k < w.length; k++) {
                            x = w[k];
                            v[k] = Math.round(x * g.scale + g.min)
                        }
                    }
                    s += p * m
                } else if ("string" === f) {
                    ...
                    v = [];
                    for (k = 0; k < E; k++) {
                        var S = new Uint32Array(e.slice(s, s + 4))[0];
                        s += 4;
                        var A = new Uint8Array(e.slice(s, s + S));
                        v.push(A),
                        s += S
                    }
                } else {
                    ...
                    if ("float32" === f)
                        ...
                        var I = new Float32Array(v.length / 2)
                          , N = new Float32Array(v.length / 2);
                        for (k = 0; k < I.length; k++)
                            I[k] = v[2 * k],
                            N[k] = v[2 * k + 1];
                        var M = ca(I, d, "float32")
                          , T = ca(N, d, "float32");
                        o[h] = ua(M, T),
                        M.dispose(),
                        T.dispose()
    ...
    var pa = "undefined" != typeof Buffer && ("undefined" == typeof Blob || "undefined" == typeof atob || "undefined" == typeof btoa);
    function va(e) {
        return pa ? Buffer.byteLength(e) : new Blob([e]).size
    }
    function ga(e) {
        if (1 === e.length)
            return e[0];
    ...
    function wa(e) {
        ...
        return {
            ...
            modelTopologyBytes: null == e.modelTopology ? 0 : va(JSON.stringify(e.modelTopology)),
            weightSpecsBytes: null == e.weightSpecs ? 0 : va(JSON.stringify(e.weightSpecs)),
        ...
        e.prototype.databaseAction = function(e, t) {
            ...
            return new Promise((function(e, r) {
                ...
                a.onsuccess = function() {
                    var i = a.result;
                    if (null == t) {
                        var o = i.transaction(Sa, "readonly")
                          , s = o.objectStore(Sa).get(n.modelPath);
                        ...
                        var u, l = wa(t), c = i.transaction(Aa, "readwrite"), h = c.objectStore(Aa), f = h.put({
                            modelPath: n.modelPath,
                            modelArtifactsInfo: l
                        });
                        f.onsuccess = function() {
                            var a = (u = i.transaction(Sa, "readwrite")).objectStore(Sa).put({
                                modelPath: n.modelPath,
                                modelArtifacts: t,
                                modelArtifactsInfo: l
                            });
                            ...
                            a.onerror = function(e) {
                                var t = (h = c.objectStore(Aa)).delete(n.modelPath);
    ...
    Na.URL_SCHEME = "indexeddb://";
    var Ma = function(e) {
        return Z().getBool("IS_BROWSER") && !Array.isArray(e) && e.startsWith(Na.URL_SCHEME) ? (t = e.slice(Na.URL_SCHEME.length),
        new Na(t)) : null;
        var t
    };
    xa.registerSaveRouter(Ma),
    xa.registerLoadRouter(Ma);
    var Ta = function() {
        function e() {
            this.indexedDB = _a()
        }
                ...
                return a(this, (function(t) {
                    return [2, new Promise((function(t, n) {
                        ...
                        r.onsuccess = function() {
                            var e = r.result
                              , a = e.transaction(Aa, "readonly")
                              , o = a.objectStore(Aa).getAll();
        ...
        e.prototype.removeModel = function(e) {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(n) {
                    var r;
                    return e = (r = e).startsWith(Na.URL_SCHEME) ? r.slice(Na.URL_SCHEME.length) : r,
                    [2, new Promise((function(n, r) {
                        var a = t.indexedDB.open(Ea, 1);
                        a.onupgradeneeded = function() {
                            return Ia(a)
                        }
                        ,
                        a.onsuccess = function() {
                            var t, i = a.result, o = i.transaction(Aa, "readwrite"), s = o.objectStore(Aa), u = s.get(e);
                            u.onsuccess = function() {
                                ...
                                var a = s.delete(e)
                                  , o = function() {
                                    var a = (t = i.transaction(Sa, "readwrite")).objectStore(Sa).delete(e);
                                    a.onsuccess = function() {
    ...
    function La(e) {
        return {
            info: [Ra, e, Ba].join(Da),
            topology: [Ra, e, Fa].join(Da),
            weightSpecs: [Ra, e, Ca].join(Da),
            weightData: [Ra, e, Pa].join(Da),
            modelMetadata: [Ra, e, Oa].join(Da)
        }
    }
    function za(e) {
        var t, n;
    ...
    function Ka(e) {
        ...
        return t.slice(1, t.length - 1).join(Da)
    }
    var qa = function() {
        function e(e) {
            if (!Z().getBool("IS_BROWSER") || "undefined" == typeof window || "undefined" == typeof window.localStorage)
                throw new Error("The current environment does not support local storage.");
            if (this.LS = window.localStorage,
            null == e || !e)
                throw new Error("For local storage, modelPath must not be null, undefined or empty.");
            this.modelPath = e,
            this.keys = La(this.modelPath)
        }
        return e.prototype.save = function(e) {
            return r(this, void 0, void 0, (function() {
                var t, n, r, i;
        ...
        e.prototype.load = function() {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    if (t.weightSpecs = r,
                    null != (i = this.LS.getItem(this.keys.modelMetadata)) && (o = JSON.parse(i),
                    t.format = o.format,
                    t.generatedBy = o.generatedBy,
                    t.convertedBy = o.convertedBy,
                    null != o.signature && (t.signature = o.signature),
                    null != o.userDefinedMetadata && (t.userDefinedMetadata = o.userDefinedMetadata),
                    null != o.modelInitializer && (t.modelInitializer = o.modelInitializer),
                    null != o.trainingConfig && (t.trainingConfig = o.trainingConfig)),
    ...
    qa.URL_SCHEME = "localstorage://";
    var Wa = function(e) {
        return Z().getBool("IS_BROWSER") && !Array.isArray(e) && e.startsWith(qa.URL_SCHEME) ? (t = e.slice(qa.URL_SCHEME.length),
        new qa(t)) : null;
        var t
    };
    xa.registerSaveRouter(Wa),
    xa.registerLoadRouter(Wa);
    var Ga = function() {
        function e() {
            p(Z().getBool("IS_BROWSER"), (function() {
                return "Current environment is not a web browser"
            }
            )),
            p("undefined" == typeof window || "undefined" != typeof window.localStorage, (function() {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    r = 0; r < this.LS.length; ++r)
                        (i = this.LS.key(r)).startsWith(t) && i.endsWith(n) && (o = Ka(i),
                        e[o] = JSON.parse(this.LS.getItem(i)));
                    return [2, e]
                }
                ))
            }
        ...
        e.prototype.removeModel = function(e) {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(r) {
                    var a;
                    if (e = (a = e).startsWith(qa.URL_SCHEME) ? a.slice(qa.URL_SCHEME.length) : a,
                    t = La(e),
      ...
      , Va = function() {
        ...
        e.registerManager = function(t, n) {
            ...
            t.endsWith(Ua) && (t = t.slice(0, t.indexOf(Ua))),
            p(t.length > 0, (function() {
                return "scheme must not be an empty string."
            }
            ));
            var r = e.getInstance();
            p(null == r.managers[t], (function() {
    ...
    function Ha(e) {
        if (-1 === e.indexOf(Ua))
            throw new Error("The url string provided does not contain a scheme. Supported schemes are: " + Va.getSchemes().join(","));
        return {
            scheme: e.split(Ua)[0],
            path: e.split(Ua)[1]
        }
        ...
        r(this, void 0, void 0, (function() {
            ...
            return a(this, (function(a) {
                ...
                case 0:
                    ...
                    p((r = xa.getLoadHandlers(e)).length > 0, (function() {
                ...
                case 1:
                    return h = a.sent(),
                    n && c ? [4, Va.getManager(u).removeModel(l)] : [3, 3];
                case 2:
                    a.sent(),
                    a.label = 3;
                case 3:
                ...
                case 4:
                    return f = a.sent(),
                    !n || c ? [3, 6] : [4, Va.getManager(u).removeModel(l)];
                case 5:
                    a.sent(),
                    a.label = 6;
                case 6:
    ...
    if (Z().get("IS_BROWSER")) {
        Z().setPlatform("browser", new Ja);
        try {
            Va.registerManager(qa.URL_SCHEME, new Ga)
        } catch (e) {}
        try {
            Va.registerManager(Na.URL_SCHEME, new Ta)
        } catch (e) {}
    }
    var Za, Ya = function() {
        ...
        return e.prototype.fetch = function(e, t) {
            return null != Z().global.fetch ? Z().global.fetch(e, t) : (null == Za && (Za = Ya()),
            Za(e, t))
        }
        ,
        e.prototype.now = function() {
    ...
    Z().get("IS_NODE") && !Z().get("IS_BROWSER") && Z().setPlatform("node", new Xa);
    var $a = sa({
        cast_: function(e, t) {
            var n = aa(e, "x", "cast");
            if (!I(t))
            ...
            return Yr.runKernel(ve, r, a)
        }
    });
    var ei = sa({
        clone_: function(e) {
            var t = {
                x: aa(e, "x", "clone", "string_or_numeric")
            };
            return Yr.runKernel(Xe, t)
        }
    });
    function ti(e, t) {
        void 0 === t && (t = !1),
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    case 1:
                        ...
                        (o = null == this.modelJsonAnchor ? document.createElement("a") : this.modelJsonAnchor).download = this.modelJsonFileName,
                        o.href = i,
                        [4, ni((function() {
                    ...
                    case 2:
                        return a.sent(),
                        null == e.weightData ? [3, 4] : ((s = null == this.weightDataAnchor ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName,
                        s.href = t,
                        [4, ni((function() {
    ...
    var ai = function() {
        ...
        e.prototype.loadWeights = function(e) {
            ...
            try {
                for (var u = i(e), l = u.next(); !l.done; l = u.next()) {
                    var c = l.value;
                    a.push.apply(a, s(c.weights)),
                    o.push.apply(o, s(c.paths))
                }
            } catch (e) {
                t = {
                    error: e
        ...
        e.prototype.checkManifestAndWeightFiles = function(e) {
            var t, n, r = this, a = [], o = this.weightsFiles.map((function(e) {
                return ma(e.name)
            }
            )), s = {};
            try {
    ...
    function ii(e, t, n, r) {
        !function(e) {
            p(null != e && Array.isArray(e) && e.length > 0, (function() {
        ...
        return r(this, void 0, void 0, (function() {
            ...
            return a(this, (function(a) {
                ...
                case 1:
                    ...
                    [3, 4];
                case 2:
                    return [4, ii(r, t.onProgress, i, o)];
                case 3:
                    s = a.sent(),
                    a.label = 4;
                case 4:
                ...
                case 5:
                    ...
                    [3, 8];
                case 6:
                    return [4, ii(u, t.onProgress, l, c)];
                case 7:
                    h = a.sent(),
                    a.label = 8;
                case 8:
            ...
            r(t, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    case 0:
                        ...
                        n.forEach((function(e, n) {
                            ...
                            e.weights.forEach((function(e) {
                                var i = "quantization"in e ? e.quantization.dtype : e.dtype
                                  , l = ha[i] * y(e.shape)
                                  , c = function() {
                                    t[n] = !0,
                                    null == r[n] && (r[n] = []),
                    ...
                    case 1:
                        ...
                        p = 0,
                        c.forEach((function(e) {
                            for (var t = n[e].paths.length, a = 0, i = 0; i < t; i++)
                                a += f[p + i].byteLength;
                            for (var o = new ArrayBuffer(a), s = new Uint8Array(o), u = 0, l = 0; l < t; l++) {
                                var c = new Uint8Array(f[p + l]);
                                s.set(c, u),
                                u += c.byteLength
                            }
                            r[e].forEach((function(e) {
                                var t = fa(o.slice(e.groupOffset, e.groupOffset + e.sizeBytes), [e.manifestEntry]);
                                for (var n in t)
                                    d[n] = t[n]
                            }
                            )),
    ...
    xa.registerSaveRouter((function(e) {
        return Z().getBool("IS_BROWSER") && !Array.isArray(e) && e.startsWith(ri.URL_SCHEME) ? function(e) {
            void 0 === e && (e = "model");
            return new ri(e)
        }(e.slice(ri.URL_SCHEME.length)) : null
    }
    ));
    var ui = function() {
        function e(e, t) {
            ...
            null != t.fetchFunc ? (p("function" == typeof t.fetchFunc, (function() {
                return "Must pass a function that matches the signature of `fetch` (see https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)"
            }
            )),
            this.fetch = t.fetchFunc) : this.fetch = Z().platform.fetch,
            p(null != e && e.length > 0, (function() {
                return "URL path for http must not be null, undefined or empty."
            }
            )),
            Array.isArray(e) && p(2 === e.length, (function() {
        ...
        e.prototype.loadWeights = function(e) {
            return r(this, void 0, void 0, (function() {
                var t, n, r, u, l, c, h, f, d, p, v, g, m, y, b, w, k, x, E, S, A, _, I, N, M, T, D;
                return a(this, (function(a) {
                    switch (a.label) {
                    case 0:
                        ...
                        r = n[0],
                        u = n[1],
                        l = this.weightPathPrefix || r,
                        c = [];
                        try {
                            for (h = i(e),
                            f = h.next(); !f.done; f = h.next())
                                d = f.value,
                                c.push.apply(c, s(d.weights))
                        } catch (e) {
                            _ = {
                                error: e
                            }
                            ...
                            m = g.next(); !m.done; m = g.next()) {
                                ...
                                try {
                                    ...
                                    w = b.next(); !w.done; w = b.next())
                                        k = w.value,
                                        null != this.weightUrlConverter ? v.push(this.weightUrlConverter(k)) : p.push(l + k + u)
                                } catch (e) {
                                    T = {
                                        error: e
                                    }
                        ...
                        [4, Promise.all(v)]) : [3, 2];
                    case 1:
                        E.apply(x, S.concat([s.apply(void 0, [a.sent()])])),
                        a.label = 2;
                    case 2:
                        return [4, oi(p, {
    ...
    function li(e) {
        return null != e.match(ui.URL_SCHEME_REGEX)
    }
    ui.URL_SCHEME_REGEX = /^https?:\/\//;
    var ci = function(e, t) {
    ...
    xa.registerSaveRouter(ci),
    xa.registerLoadRouter(ci);
    var fi = function() {
        function e(e) {
    ...
    var pi = {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(c) {
                    ...
                    case 0:
                        for (n = [],
                        i = [],
                        o = Array.isArray(e) ? e.map((function(e) {
                            return e.name
                        }
                        )) : Object.keys(e),
                        s = function(s) {
                            var u = o[s]
                              , c = Array.isArray(e) ? e[s].tensor : e[u];
        ...
        fromMemory: function(e, t, n, r) {
            if (1 === arguments.length) {
                ...
                return a ? new fi(e) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."),
                new fi({
                    modelTopology: e
                }))
            }
        ...
        getLoadHandlers: function(e, t) {
            return xa.getLoadHandlers(e, t)
        },
        getModelArtifactsForJSON: ba,
        getModelArtifactsInfoForJSON: wa,
        getSaveHandlers: function(e) {
            return xa.getSaveHandlers(e)
        },
        http: hi,
        isHTTPScheme: li,
        loadWeights: function(e, t, n, i) {
            return void 0 === t && (t = ""),
            r(this, void 0, void 0, (function() {
                return a(this, (function(r) {
                    return [2, si((function(e) {
                        return oi(e, {
                            requestInit: i
                        })
                    }
        ...
        registerLoadRouter: function(e) {
            return xa.registerLoadRouter(e)
        },
        registerSaveRouter: function(e) {
            return xa.registerSaveRouter(e)
        },
        ...
        removeModel: function(e) {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(n) {
                    return t = Ha(e),
                    [2, Va.getManager(t.scheme).removeModel(t.path)]
                }
                ))
            }
            ))
    ...
    var gi = sa({
        oneHot_: function(e, t, n, r) {
            ...
            var a = {
                indices: aa(e, "indices", "oneHot", "int32")
            }
              , i = {
                depth: t,
                onValue: n,
    ...
    var yi = {
        ...
        confusionMatrix: sa({
            confusionMatrix_: function(e, t, n) {
                var r = aa(e, "labels", "confusionMatrix")
                  , a = aa(t, "predictions", "confusionMatrix");
                p(null == n || n > 0 && Number.isInteger(n), (function() {
                ...
                p(r.shape[0] === a.shape[0], (function() {
    ...
    function Ai(e, t) {
        ...
        if (null != Nn(wn, Yr.backendName)) {
            ...
            return Yr.runKernel(wn, l, c)
        }
        var h, f, d = o(a ? [e.videoWidth, e.videoHeight] : [e.width, e.height], 2), p = d[0], v = d[1];
        if (s)
            ...
            if (null == xi)
                if ("undefined" == typeof document) {
                    ...
                    xi = new OffscreenCanvas(1,1).getContext("2d")
                } else
                    xi = document.createElement("canvas").getContext("2d");
            xi.canvas.width = p,
            xi.canvas.height = v,
            xi.drawImage(e, 0, 0, p, v),
            h = xi.getImageData(0, 0, p, v).data
        }
        if (4 === t)
            f = new Int32Array(h);
        else {
    ...
    var Ii = {
        ...
        fromPixelsAsync: function(e, t) {
            ...
            r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    case 0:
                        if (n = null,
                        !Z().getBool("WRAP_TO_IMAGEBITMAP") || !_i(e))
                            return [3, 5];
                        r = void 0,
                        a.label = 1;
                    case 1:
        ...
        toPixels: function(e, t) {
            return r(this, void 0, void 0, (function() {
                var n, r, i, s, u, l, c, h, f, d, p, v, g, m, y, b;
                return a(this, (function(a) {
                    switch (a.label) {
                    case 0:
                        if (n = aa(e, "img", "toPixels"),
                        e instanceof Dr || (n = $a(r = n, "int32"),
                        r.dispose()),
                        2 !== n.rank && 3 !== n.rank)
                            throw new Error("toPixels only supports rank 2 or 3 tensors, got rank " + n.rank + ".");
                        if (i = o(n.shape.slice(0, 2), 2),
                        s = i[0],
                        u = i[1],
                        (l = 2 === n.rank ? 1 : n.shape[2]) > 4 || 2 === l)
                            throw new Error("toPixels only supports depth of size 1, 3 or 4 but got " + l);
                    ...
                    case 1:
                        ...
                        return null != t && (t.width = u,
                        t.height = s,
                        y = t.getContext("2d"),
                        b = new ImageData(f,u,s),
    ...
    function Ni(e, t) {
        ...
        for (var a = t.shape, i = a[a.length - 1], o = 1, u = 0; u < a.length - 1; ++u)
            o *= a[u];
        var l = e.shape
          , c = a.slice();
        c.pop();
        ...
        for (u = i; u < n; ++u)
            h *= l[u],
            c.push(l[u]);
        var f = s(O(e.shape).map((function(e) {
            return e / h
        }
        )), [1]).slice(0, i);
        return [c, o, h, f]
    ...
    function Ri(e, t, n) {
        for (var r = t.shape.length, a = r > 1 ? t.shape[r - 1] : 1, i = n.length, o = 1, u = a; u < i; ++u)
            o *= n[u];
        var l = a < 1 ? 1 : a;
        return {
            sliceRank: a,
    ...
    function Fi(e, t, n, r) {
        for (var a = s(e), i = a.length; i < r.length; i++)
            a.push(1);
        for (i = 0; i < n; i++)
    ...
    function Oi(e, t, n, r, a) {
        for (var i = s(a), o = Pi(n, t), u = 0; u < i.length; u++)
            if (o.indexOf(u) > -1)
                i[u] = 0;
            else {
                var l = Ci(t, n, u)
    ...
    function Li(e, t, n, r, a) {
        for (var i = s(a), o = Pi(n, t), u = 0; u < i.length; u++)
            if (o.indexOf(u) > -1)
                ...
                var l = Ci(t, n, u)
                  , c = r[l];
                e & 1 << l && (c = Number.MAX_SAFE_INTEGER),
                i[u] = c
            }
    ...
    var Gi = {
        ...
        startIndicesWithElidedDims: Oi,
        stopIndicesWithElidedDims: Li,
        stridesForAxis: zi,
        startForAxis: Ki,
        stopForAxis: qi,
        ...
        parseSliceParams: function(e, t, n) {
            ...
            return (r = "number" == typeof t ? s([t], new Array(i - 1).fill(0)) : t.length < i ? t.concat(new Array(i - t.length).fill(0)) : t.slice()).forEach((function(e) {
                p(-1 !== e, (function() {
            ...
            a = (a = null == n ? new Array(i).fill(-1) : "number" == typeof n ? s([n], new Array(i - 1).fill(-1)) : n.length < i ? n.concat(new Array(i - n.length).fill(-1)) : n).map((function(t, n) {
                return t >= 0 ? t : (p(-1 === t, (function() {
                ...
                if (-1 !== w) {
                    ...
                    if (d.beginValid && d.endValid) {
                        if (b) {
                            ...
                            d.begin[f] = Wi(d.begin[f], 0, d.strides[f], w, k, x),
                            d.end[f] = Wi(d.end[f], 1, d.strides[f], w, k, x);
                    ...
                    I) {
                        var N = void 0;
                        N = 0 === _ || _ < 0 != d.strides[f] < 0 ? 0 : Math.trunc(_ / d.strides[f]) + (_ % d.strides[f] != 0 ? 1 : 0),
                        m.push(N)
                    } else
                        m.push(-1)
                } else
    ...
    function Hi(e) {
        p(null != e.className, (function() {
            return "Class being registered does not have the static className property defined."
        }
        )),
        p("string" == typeof e.className, (function() {
            return "className is required to be a string, but got type " + typeof e.className
        }
        )),
        p(e.className.length > 0, (function() {
    ...
    function Ji() {
        return 32 === Yr.backend.floatPrecision() ? .001 : .1
    }
    function Zi(e, t, n) {
        var r = !0;
        if ((N(e) || N(t)) && (r = !1),
    ...
    var Xi = {
        ...
        expectArraysEqual: function(e, t) {
            ...
            return D(e) || D(e[0]) || D(t) || D(t[0]) ? Zi(e, n, (function(e, t) {
                return e == t
            }
            )) : Zi(e, t, (function(e, t) {
                return Yi(e, t, 0)
    ...
    var to = sa({
        add_: function(e, t) {
            var n, r = aa(e, "a", "add"), a = aa(t, "b", "add"), i = {
                a: r = (n = o(Kr(r, a), 2))[0],
                b: a = n[1]
            };
            return Yr.runKernel(ee, i)
        }
    });
    var no = sa({
        floorDiv_: function(e, t) {
            var n, r = aa(e, "a", "floorDiv"), a = aa(t, "b", "floorDiv"), i = {
                a: r = (n = o(Kr(r, a), 2))[0],
                b: a = n[1]
            };
            return Yr.runKernel(Ve, i)
        }
    });
    var ro = sa({
        div_: function(e, t) {
            var n, r = aa(e, "a", "div"), a = aa(t, "b", "div");
            if (r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ...
            return Yr.runKernel(Oe, i, {})
        }
    });
    var ao = sa({
        mul_: function(e, t) {
            var n, r = aa(e, "a", "mul"), a = aa(t, "b", "mul"), i = {
                a: r = (n = o(Kr(r, a), 2))[0],
                b: a = n[1]
            };
            return Yr.runKernel(bt, i)
        }
    });
    var io = sa({
        abs_: function(e) {
    ...
    var go = sa({
        atan_: function(e) {
            ...
            return Yr.runKernel(oe, t)
        }
    });
    var mo = sa({
        atan2_: function(e, t) {
            var n, r = aa(e, "a", "atan2"), a = aa(t, "b", "atan2"), i = {
                a: r = (n = o(Kr(r, a), 2))[0],
                b: a = n[1]
            };
            return Yr.runKernel(ue, i)
        }
    });
    var yo = sa({
        atanh_: function(e) {
            ...
            return Yr.runKernel(se, t)
        }
    });
    function bo(e, t, n, r, a, i, s) {
        void 0 === s && (s = "channelsLast");
        var u, l = o(Eo(t), 2), c = l[0], h = l[1];
        if ("channelsLast" === s)
            u = [c, h, e[3], e[3]];
        else {
            if ("channelsFirst" !== s)
        ...
        return wo(e, u, n, r, a, i, !1, s)
    }
    function wo(e, t, n, r, a, i, s, u) {
        var l, c;
        void 0 === s && (s = !1),
        ...
        var g, m = o(t, 4), y = m[0], b = m[1], w = m[3], k = o(Eo(n), 2), x = k[0], E = k[1], S = o(Eo(r), 2), A = S[0], _ = S[1], I = Ao(y, A), N = Ao(b, _), M = function(e, t, n, r, a, i, o, s, u) {
            var l, c, h;
            if ("number" == typeof e) {
                l = {
                    top: e,
        ...
        }(a, d, p, x, E, I, N, i, u), T = M.padInfo, D = M.outHeight, R = M.outWidth, B = s ? w * v : w;
        return "channelsFirst" === u ? g = [f, B, D, R] : "channelsLast" === u && (g = [f, D, R, B]),
        {
            batchSize: f,
            dataFormat: u,
            inHeight: d,
    ...
    function ko(e, t, n, r, a, i, s, u) {
        ...
        var m, y = o(t, 5), b = y[0], w = y[1], k = y[2], x = y[4], E = o(So(n), 3), S = E[0], A = E[1], _ = E[2], I = o(So(r), 3), N = I[0], M = I[1], T = I[2], D = Ao(b, N), R = Ao(w, M), B = Ao(k, T), F = function(e, t, n, r, a, i, o, s, u, l, c) {
            var h, f, d, p;
            if ("number" == typeof e) {
                h = {
                    top: e,
        ...
        }(a, d, p, v, S, A, _, D, R, B, u), C = F.padInfo, P = F.outDepth, O = F.outHeight, L = F.outWidth, z = i ? x * g : x;
        return "channelsFirst" === s ? m = [f, z, P, O, L] : "channelsLast" === s && (m = [f, P, O, L, z]),
        {
            batchSize: f,
            dataFormat: s,
            inDepth: d,
    ...
    var Do = sa({
        reshape_: function(e, t) {
            var n = {
                x: aa(e, "x", "reshape", "string_or_numeric")
            }
              , r = {
                shape: t
            };
            return Yr.runKernel(Ft, n, r)
        }
    });
    var Ro = sa({
        avgPool_: function(e, t, n, r, a) {
            var i = aa(e, "x", "avgPool", "float32");
            p(No(n, 1), (function() {
            ...
            var o = i
              , s = !1;
            3 === i.rank && (s = !0,
            o = Do(i, [1, i.shape[0], i.shape[1], i.shape[2]])),
            p(4 === o.rank, (function() {
            ...
            var u = {
              ...
              , c = Yr.runKernel(le, u, l);
            return c = $a(c, i.dtype),
            s ? Do(c, [c.shape[1], c.shape[2], c.shape[3]]) : c
        }
    });
    var Bo = sa({
        avgPool3d_: function(e, t, n, r, a, i) {
            void 0 === i && (i = "NDHWC");
            var o = aa(e, "x", "avgPool3d", "float32")
              , s = o
              , u = !1;
            4 === o.rank && (u = !0,
            s = Do(o, [1, o.shape[0], o.shape[1], o.shape[2], o.shape[3]])),
            p(5 === s.rank, (function() {
            ...
            var l = {
              ...
              , h = Yr.runKernel(ce, l, c);
            return h = $a(h, s.dtype),
            u ? Do(h, [h.shape[1], h.shape[2], h.shape[3], h.shape[4]]) : h
        }
    });
    var Fo = sa({
        concat_: function(e, t) {
            ...
            var n = ia(e, "tensors", "concat", "string_or_numeric");
            ...
            return Yr.runKernel(we, r, a)
        }
    });
    var Co = sa({
        sigmoid_: function(e) {
            var t = {
                x: aa(e, "x", "sigmoid", "float32")
            };
            return Yr.runKernel(jt, t)
        }
    });
    var Po = sa({
        slice_: function(e, t, n) {
            var r = aa(e, "x", "slice", "string_or_numeric");
            if (0 === r.rank)
            ...
            return Yr.runKernel(Ut, a, i)
        }
    });
    var Oo = sa({
        tanh_: function(e) {
            var t = {
                x: aa(e, "x", "tanh", "float32")
            };
            return Yr.runKernel(cn, t)
        }
    });
    var Lo = sa({
        basicLSTMCell_: function(e, t, n, r, a, i) {
            var o = aa(e, "forgetBias", "basicLSTMCell")
              , s = aa(t, "lstmKernel", "basicLSTMCell")
              , u = aa(n, "lstmBias", "basicLSTMCell")
              , l = aa(r, "data", "basicLSTMCell")
              , c = aa(a, "c", "basicLSTMCell")
              , h = aa(i, "h", "basicLSTMCell")
              , f = Fo([l, h], 1)
              , d = vi(f, s)
              , p = to(d, u)
              , v = p.shape[0]
    ...
    var zo = sa({
        batchToSpaceND_: function(e, t, n) {
            ...
            return Yr.runKernel(fe, i, o)
        }
    });
    var Ko = sa({
        batchNorm_: function(e, t, n, r, a, i) {
            null == i && (i = .001);
            var o, s, u = aa(e, "x", "batchNorm"), l = aa(t, "mean", "batchNorm"), c = aa(n, "variance", "batchNorm");
            null != a && (o = aa(a, "scale", "batchNorm")),
            null != r && (s = aa(r, "offset", "batchNorm")),
            p(l.rank === c.rank, (function() {
                return "Batch normalization gradient requires mean and variance to have equal ranks."
            }
            )),
            p(null == s || l.rank === s.rank, (function() {
                return "Batch normalization gradient requires mean and offset to have equal ranks."
            }
            )),
            p(null == o || l.rank === o.rank, (function() {
                return "Batch normalization gradient requires mean and scale to have equal ranks."
            }
            ));
            var h = {
                x: function(e) {
                    return 0 === e.rank || 1 === e.rank ? Do(e, [1, 1, 1, e.size]) : 2 === e.rank ? Do(e, [1, 1, e.shape[0], e.shape[1]]) : 3 === e.rank ? Do(e, [1, e.shape[0], e.shape[1], e.shape[2]]) : e
                }(u),
                scale: o,
                offset: s,
                mean: l,
    ...
    var qo = sa({
        batchNorm2d_: function(e, t, n, r, a, i) {
            var o, s, u = aa(e, "x", "batchNorm"), l = aa(t, "mean", "batchNorm"), c = aa(n, "variance", "batchNorm");
            return null != a && (o = aa(a, "scale", "batchNorm")),
            null != r && (s = aa(r, "offset", "batchNorm")),
            p(2 === u.rank, (function() {
            ...
            null != o && p(2 === o.rank || 1 === o.rank, (function() {
    ...
    var Wo = sa({
        batchNorm3d_: function(e, t, n, r, a, i) {
            ...
            null != o && p(3 === o.rank || 1 === o.rank, (function() {
    ...
    var Go = sa({
        batchNorm4d_: function(e, t, n, r, a, i) {
            ...
            null != o && p(4 === o.rank || 1 === o.rank, (function() {
    ...
    var Uo = sa({
        bincount_: function(e, t, n) {
            var r = aa(e, "x", "bincount")
              , a = aa(t, "weights", "bincount");
            p("int32" === r.dtype, (function() {
            ...
            p(a.size === r.size || 0 === a.size, (function() {
            ...
            return Yr.runKernel(de, i, o)
        }
    });
    var Vo = sa({
        broadcastArgs_: function(e, t) {
            var n = aa(e, "s0", "broadcastArgs", "int32")
              , r = aa(t, "s1", "broadcastArgs", "int32");
            if (1 !== n.rank)
            ...
            return Yr.runKernel(pe, a)
        }
    });
    var Ho = sa({
        broadcastTo_: function(e, t) {
            var n = aa(e, "broadcastTo", "x")
              , r = n.shape;
            ...
            return Yr.runKernel(hn, u, l)
        }
    });
    var jo = sa({
        ceil_: function(e) {
            var t = {
                x: aa(e, "x", "ceil", "float32")
            };
            return Yr.runKernel(ge, t)
        }
    });
    var Jo = sa({
        clipByValue_: function(e, t, n) {
            var r = aa(e, "x", "clipByValue");
            p(t <= n, (function() {
    ...
    var $o = sa({
        conv2d_: function(e, t, n, r, a, i, o) {
            void 0 === a && (a = "NHWC"),
            void 0 === i && (i = [1, 1]);
            var s = aa(e, "x", "conv2d", "float32")
              , u = aa(t, "filter", "conv2d", "float32")
              , l = s
              , c = !1;
            3 === s.rank && (c = !0,
            l = Do(s, [1, s.shape[0], s.shape[1], s.shape[2]])),
            p(4 === l.rank, (function() {
            ...
            var f = {
              ...
              , v = Yr.runKernel(ke, f, d);
            return c ? Do(v, [v.shape[1], v.shape[2], v.shape[3]]) : v
        }
    });
    var es = sa({
        conv1d_: function(e, t, n, r, a, i, o) {
            ...
            void 0 === i && (i = 1);
            var s = aa(e, "x", "conv1d")
              , u = aa(t, "filter", "conv1d")
              , l = s
              , c = !1;
            2 === s.rank && (c = !0,
            l = Do(s, [1, s.shape[0], s.shape[1]])),
            p(3 === l.rank, (function() {
            ...
            var h = Do(u, [1, u.shape[0], u.shape[1], u.shape[2]])
              , f = Do(l, [l.shape[0], 1, l.shape[1], l.shape[2]])
              , d = $o(f, h, [1, n], r, "NHWC", [1, i], o);
            return Do(d, c ? [d.shape[2], d.shape[3]] : [d.shape[0], d.shape[2], d.shape[3]])
        }
    });
    var ts = sa({
        conv2DBackpropInput_: function(e, t, n, r, a, i, o) {
            void 0 === i && (i = "NHWC"),
            p(e.length === t.rank, (function() {
            ...
            var s = e
              ...
              , l = !1;
            3 === t.rank && (l = !0,
            u = Do(t, [1, t.shape[0], t.shape[1], t.shape[2]]),
            s = [1, e[0], e[1], e[2]]),
            p(4 === s.length, (function() {
            ...
            var f = {
              ...
              , v = Yr.runKernel(Ee, f, d);
            return l ? Do(v, [v.shape[1], v.shape[2], v.shape[3]]) : v
        }
    });
    var ns = sa({
        conv2dTranspose_: function(e, t, n, r, a, i) {
            var o = aa(e, "x", "conv2dTranspose")
              , s = aa(t, "filter", "conv2dTranspose");
            return ts(n, o, s, r, a, "NHWC", i)
        }
    });
    var rs = sa({
        conv3d_: function(e, t, n, r, a, i) {
            ...
            void 0 === i && (i = [1, 1, 1]);
            var o = aa(e, "x", "conv3d")
              , s = aa(t, "filter", "conv3d")
              , u = o
              , l = !1;
            4 === o.rank && (l = !0,
            u = Do(o, [1, o.shape[0], o.shape[1], o.shape[2], o.shape[3]])),
            p(5 === u.rank, (function() {
            ...
            p(u.shape[4] === s.shape[3], (function() {
            ...
            var c = {
              ...
              , f = Yr.runKernel(Se, c, h);
            return l ? Do(f, [f.shape[1], f.shape[2], f.shape[3], f.shape[4]]) : f
        }
    });
    var as = sa({
        conv3DBackpropInput_: function(e, t, n, r, a) {
            ...
            var i = e
              ...
              , s = !1;
            4 === t.rank && (s = !0,
            o = Do(t, [1, t.shape[0], t.shape[1], t.shape[2], t.shape[3]]),
            i = [1, e[0], e[1], e[2], e[3]]);
            var u = i[4]
              , l = o.shape[4];
            ...
            var c = {
              ...
              , f = Yr.runKernel(Ae, c, h);
            return s ? Do(f, [f.shape[1], f.shape[2], f.shape[3], f.shape[4]]) : f
        }
    });
    var is = sa({
        conv3dTranspose_: function(e, t, n, r, a) {
            var i = aa(e, "x", "conv3dTranspose")
              , o = aa(t, "filter", "conv3dTranspose");
            return as(n, i, o, r, a)
        }
    });
    var os = sa({
        cos_: function(e) {
            var t = {
                x: aa(e, "x", "cos", "float32")
            };
            return Yr.runKernel("Cos", t)
        }
    });
    var ss = sa({
        cosh_: function(e) {
            var t = {
                x: aa(e, "x", "cosh", "float32")
            };
            return Yr.runKernel(_e, t)
        }
    });
    var us = sa({
    ...
    var ls = sa({
        cumsum_: function(e, t, n, r) {
            ...
            return Yr.runKernel(Ne, a, i)
        }
    });
    var cs = sa({
        denseBincount_: function(e, t, n, r) {
            void 0 === r && (r = !1);
            var a = aa(e, "x", "denseBincount")
              , i = aa(t, "weights", "denseBincount");
            p("int32" === a.dtype, (function() {
            ...
            p(i.size === a.size || 0 === i.size, (function() {
            ...
            return Yr.runKernel(Te, o, s)
        }
    });
    var hs = sa({
        depthToSpace_: function(e, t, n) {
            void 0 === n && (n = "NHWC");
            var r = aa(e, "x", "depthToSpace", "float32")
    ...
    var fs = sa({
        depthwiseConv2d_: function(e, t, n, r, a, i, o) {
            void 0 === a && (a = "NHWC"),
            void 0 === i && (i = [1, 1]);
            var s = aa(e, "x", "depthwiseConv2d", "float32")
              , u = aa(t, "filter", "depthwiseConv2d", "float32")
              , l = s
              , c = !1;
            3 === s.rank && (c = !0,
            l = Do(s, [1, s.shape[0], s.shape[1], s.shape[2]])),
            ...
            p(l.shape[3] === u.shape[2], (function() {
            ...
            var h = {
              ...
              , d = Yr.runKernel(Re, h, f);
            return c ? Do(d, [d.shape[1], d.shape[2], d.shape[3]]) : d
        }
    });
    var ds = sa({
        diag_: function(e) {
    ...
    var ps = sa({
        dilation2d_: function(e, t, n, r, a, i) {
            void 0 === a && (a = [1, 1]),
            void 0 === i && (i = "NHWC");
            var o = aa(e, "x", "dilation2d")
              , s = aa(t, "filter", "dilation2d");
            p(3 === o.rank || 4 === o.rank, (function() {
            ...
            var u = o
              , l = !1;
            3 === o.rank && (u = Do(o, [1, o.shape[0], o.shape[1], o.shape[2]]),
            l = !0);
            var c = {
                x: u,
                filter: s
              ...
              , f = Yr.runKernel(Pe, c, h);
            return l ? Do(f, [f.shape[1], f.shape[2], f.shape[3]]) : f
        }
    });
    var vs = sa({
        equal_: function(e, t) {
            var n, r = aa(e, "a", "equal", "string_or_numeric"), a = aa(t, "b", "equal", "string_or_numeric");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ki(r.shape, a.shape);
            var i = {
    ...
    var gs = sa({
        where_: function(e, t, n) {
            var r = aa(t, "a", "where")
              , a = aa(n, "b", "where")
              , i = aa(e, "condition", "where", "bool")
              , o = ki(ki(i.shape, r.shape), a.shape)
              , s = {
                condition: Ho(i, o),
                t: Ho(r, o),
                e: Ho(a, o)
            };
            return Yr.runKernel(Wt, s)
        }
    });
    var ms = sa({
    ...
    var bs = sa({
        dot_: function(e, t) {
            ...
            return s = Do(r, [r.shape[0], r.shape[1]]),
            u = vi(n, s)
        }
    });
    var ws = sa({
        einsum_: function(e) {
            ...
            var r = t.map((function(e, t) {
                return aa(e, "tensors" + t, "einsum")
            }
            ))
              , a = {
                equation: e
            };
            return Yr.runKernel(Le, r, a)
        }
    });
    var ks = sa({
        elu_: function(e) {
            var t = {
                x: aa(e, "x", "elu", "float32")
            };
            return Yr.runKernel("Elu", t)
        }
    });
    var xs = sa({
        erf_: function(e) {
            var t = aa(e, "x", "erf");
            p("int32" === t.dtype || "float32" === t.dtype, (function() {
                return "Input dtype must be `int32` or `float32`."
            }
            )),
            "int32" === t.dtype && (t = $a(t, "float32"));
            var n = {
                x: t
            };
            return Yr.runKernel("Erf", n)
        }
    });
    var Es = sa({
        exp_: function(e) {
            ...
            return Yr.runKernel("Exp", t)
        }
    });
    var Ss = sa({
        expandDims_: function(e, t) {
            void 0 === t && (t = 0);
            var n = aa(e, "x", "expandDims", "string_or_numeric");
            p(t <= n.rank, (function() {
    ...
    var As = sa({
        expm1_: function(e) {
            ...
            return Yr.runKernel(qe, t)
        }
    });
    var _s = sa({
        tile_: function(e, t) {
            var n = aa(e, "x", "tile", "string_or_numeric");
            p(n.rank === t.length, (function() {
    ...
    var Is = sa({
        eye_: function(e, t, n, r) {
            void 0 === r && (r = "float32"),
            null == t && (t = e);
            for (var a = Qa([e, t], r), i = e <= t ? e : t, o = 0; o < i; ++o)
                a.set(1, o, o);
            var s = Do(a.toTensor(), [e, t]);
            if (null == n)
                return s;
            if (1 === n.length)
                return _s(Ss(s, 0), [n[0], 1, 1]);
            if (2 === n.length)
                return _s(Ss(Ss(s, 0), 0), [n[0], n[1], 1, 1]);
            if (3 === n.length)
                return _s(Ss(Ss(Ss(s, 0), 0), 0), [n[0], n[1], n[2], 1, 1]);
    ...
    function Ns(e, t, n) {
        ...
        return Yr.runKernel(We, {}, r)
    }
    var Ms = sa({
        floor_: function(e) {
            var t = {
                x: aa(e, "x", "floor", "float32")
            };
            return Yr.runKernel(Ue, t)
        }
    });
    var Ts = sa({
        gather_: function(e, t, n, r) {
            ...
            var a = {
                x: aa(e, "x", "gather"),
                indices: aa(t, "indices", "gather", "int32")
            }
              , i = {
                axis: n,
                batchDims: r
            };
            return Yr.runKernel(je, a, i)
        }
    });
    var Ds = sa({
        greater_: function(e, t) {
            var n, r = aa(e, "a", "greater", "string_or_numeric"), a = aa(t, "b", "greater", "string_or_numeric");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ki(r.shape, a.shape);
            var i = {
    ...
    var Rs = sa({
        greaterEqual_: function(e, t) {
            var n, r = aa(e, "a", "greaterEqual", "string_or_numeric"), a = aa(t, "b", "greaterEqual", "string_or_numeric");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ki(r.shape, a.shape);
            var i = {
            ...
            return Yr.runKernel(Ye, i)
        }
    });
    var Bs = sa({
        imag_: function(e) {
            var t = {
                input: aa(e, "input", "imag")
            };
            return Yr.runKernel($e, t)
        }
    });
    var Fs = sa({
    ...
    var Os = sa({
        leakyRelu_: function(e, t) {
            ...
            return Yr.runKernel(rt, n, r)
        }
    });
    var Ls = sa({
        less_: function(e, t) {
            var n, r = aa(e, "a", "less", "string_or_numeric"), a = aa(t, "b", "less", "string_or_numeric");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ki(r.shape, a.shape);
            var i = {
            ...
            return Yr.runKernel(at, i)
        }
    });
    var zs = sa({
        lessEqual_: function(e, t) {
            var n, r = aa(e, "a", "lessEqual", "string_or_numeric"), a = aa(t, "b", "lessEqual", "string_or_numeric");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ki(r.shape, a.shape);
            var i = {
    ...
    var Ks = sa({
        localResponseNormalization_: function(e, t, n, r, a) {
            ...
            void 0 === r && (r = 1),
            void 0 === a && (a = .5);
            var i = aa(e, "x", "localResponseNormalization");
            p(4 === i.rank || 3 === i.rank, (function() {
            ...
            var u = {
              ...
              , c = Yr.runKernel("LRN", u, l);
            return s ? Do(c, [c.shape[1], c.shape[2], c.shape[3]]) : c
        }
    });
    var qs = sa({
        log_: function(e) {
            var t = {
                x: aa(e, "x", "log", "float32")
            };
            return Yr.runKernel("Log", t)
        }
    });
    var Ws = sa({
        log1p_: function(e) {
    ...
    function Gs(e, t) {
        ...
        p(null == t || Array.isArray(t) && t.every((function(e) {
        ...
        if (!n)
            for (var r in t = [],
            Yr.registeredVariables)
                t.push(Yr.registeredVariables[r]);
        var a = n ? t.filter((function(e) {
            return !e.trainable
        }
        )) : null
          , i = t.length;
        p((t = t.filter((function(e) {
            return e.trainable
        }
        ))).length > 0, (function() {
    ...
    var Zs = sa({
        max_: function(e, t, n) {
            ...
            return Yr.runKernel("Max", r, a)
        }
    });
    var Ys = sa({
        sub_: function(e, t) {
            var n, r = aa(e, "a", "sub"), a = aa(t, "b", "sub"), i = {
                a: r = (n = o(Kr(r, a), 2))[0],
                b: a = n[1]
            };
            return Yr.runKernel("Sub", i)
        }
    });
    var Xs = sa({
        sum_: function(e, t, n) {
    ...
    var ru = sa({
        logicalAnd_: function(e, t) {
            var n = aa(e, "a", "logicalAnd", "bool")
              , r = aa(t, "b", "logicalAnd", "bool");
            ki(n.shape, r.shape);
            var a = {
                a: n,
                b: r
            };
            return Yr.runKernel(ut, a)
        }
    });
    var au = sa({
        logicalNot_: function(e) {
            var t = {
                x: aa(e, "x", "logicalNot", "bool")
            };
            return Yr.runKernel(lt, t)
        }
    });
    var iu = sa({
        logicalOr_: function(e, t) {
            var n = aa(e, "a", "logicalOr", "bool")
              , r = aa(t, "b", "logicalOr", "bool");
            ki(n.shape, r.shape);
            var a = {
                a: n,
                b: r
            };
            return Yr.runKernel(ct, a)
        }
    });
    var ou = sa({
        logicalXor_: function(e, t) {
            var n = aa(e, "a", "logicalXor", "bool")
              , r = aa(t, "b", "logicalXor", "bool");
            return ki(n.shape, r.shape),
            ru(iu(e, t), au(ru(e, t)))
        }
    });
    var su = sa({
        maxPool_: function(e, t, n, r, a) {
            var i = aa(e, "x", "maxPool")
              , o = i
              , s = !1;
            3 === i.rank && (s = !0,
            o = Do(i, [1, i.shape[0], i.shape[1], i.shape[2]])),
    ...
    var uu = sa({
        maxPool3d_: function(e, t, n, r, a, i) {
            ...
            var l = {
              ...
              , h = Yr.runKernel(dt, l, c);
            return u ? Do(h, [h.shape[1], h.shape[2], h.shape[3], h.shape[4]]) : h
        }
    });
    var lu = sa({
    ...
    var cu = sa({
        maximum_: function(e, t) {
            var n, r = aa(e, "a", "maximum"), a = aa(t, "b", "maximum");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            "bool" === r.dtype && (r = $a(r, "int32"),
            a = $a(a, "int32")),
    ...
    var pu = sa({
        min_: function(e, t, n) {
            ...
            return Yr.runKernel("Min", r, a)
        }
    });
    var vu = sa({
        minimum_: function(e, t) {
            var n, r = aa(e, "a", "minimum"), a = aa(t, "b", "minimum");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            "bool" === r.dtype && (r = $a(r, "int32"),
            a = $a(a, "int32")),
    ...
    var gu = sa({
        mirrorPad_: function(e, t, n) {
            ...
            return Yr.runKernel(mt, u, s)
        }
    });
    var mu = sa({
        mod_: function(e, t) {
            var n, r = aa(e, "a", "mod"), a = aa(t, "b", "mod"), i = {
                a: r = (n = o(Kr(r, a), 2))[0],
                b: a = n[1]
            };
            return Yr.runKernel("Mod", i)
        }
    });
    var yu = sa({
        square_: function(e) {
            var t = aa(e, "x", "square");
            return Yr.runKernel("Square", {
                x: t
            }, {})
        }
    });
    var bu = sa({
        moments_: function(e, t, n) {
            void 0 === t && (t = null),
            void 0 === n && (n = !1);
            var r = x(t, (e = aa(e, "x", "moments")).shape)
              , a = hu(e, r, n)
              , i = a.shape;
            n || (i = tu(a.shape, r));
            var o = yu(Ys($a(e, "float32"), Do(a, i)));
            return {
                mean: a,
                variance: hu(o, r, n)
            }
    ...
    var wu = sa({
        multiRNNCell_: function(e, t, n, r) {
            for (var a = aa(t, "data", "multiRNNCell"), i = ia(n, "c", "multiRNNCell"), o = ia(r, "h", "multiRNNCell"), s = a, u = [], l = 0; l < e.length; l++) {
                var c = e[l](s, i[l], o[l]);
                u.push(c[0]),
                u.push(c[1]),
                s = c[1]
    ...
    var ku = sa({
        multinomial_: function(e, t, n, r) {
            ...
            var s = {
              ...
              , l = Yr.runKernel(yt, s, u);
            return 1 === o ? Do(l, [l.size]) : l
        }
    });
    var xu = sa({
        notEqual_: function(e, t) {
            var n, r = aa(e, "a", "notEqual", "string_or_numeric"), a = aa(t, "b", "notEqual", "string_or_numeric");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ki(r.shape, a.shape);
            var i = {
    ...
    var Su = sa({
        outerProduct_: function(e, t) {
            var n = aa(e, "v1", "outerProduct")
              , r = aa(t, "v2", "outerProduct");
    ...
    var Iu = sa({
        pad2d_: function(e, t, n) {
            return void 0 === n && (n = 0),
            p(2 === t.length && 2 === t[0].length && 2 === t[1].length, (function() {
                return "Invalid number of paddings. Must be length of 2 each."
            }
            )),
            Au(e, t, n)
    ...
    var Nu = sa({
        pad3d_: function(e, t, n) {
            return void 0 === n && (n = 0),
            p(3 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length, (function() {
                return "Invalid number of paddings. Must be length of 2 each."
            }
            )),
            Au(e, t, n)
    ...
    var Mu = sa({
        pad4d_: function(e, t, n) {
            return void 0 === n && (n = 0),
            p(4 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length && 2 === t[3].length, (function() {
                return "Invalid number of paddings. Must be length of 2 each."
            }
            )),
            Au(e, t, n)
    ...
    var Tu = sa({
        spaceToBatchND_: function(e, t, n) {
            ...
            p(r.shape.reduce((function(e, r, a) {
            ...
            return Yr.runKernel(Yt, a, i)
        }
    });
    var Du = sa({
        pool_: function(e, t, n, r, a, i, s) {
            null == a && (a = [1, 1]),
            null == i && (i = 1),
            0 === r && (r = "valid");
            var u = aa(e, "x", "maxPool")
              , l = u
              , c = !1;
            3 === u.rank && (c = !0,
            l = Do(u, [1, u.shape[0], u.shape[1], u.shape[2]])),
            p(No(i, a), (function() {
                return "Error in pool: Either strides or dilations must be 1. Got strides " + i + " and dilations '" + a + "'"
            }
            ));
            var h, f = bo(l.shape, t, i, a, r), d = [f.dilationHeight, f.dilationWidth];
            ...
            : function() {
              ...
              , x = v ? k : zo(k, d, y);
            return c ? Do(x, [x.shape[1], x.shape[2], x.shape[3]]) : x
        }
    });
    var Ru = sa({
        pow_: function(e, t) {
            var n, r = aa(e, "base", "pow"), a = aa(t, "exp", "pow"), i = {
                a: r = (n = o(Kr(r, a), 2))[0],
                b: a = n[1]
            };
            return Yr.runKernel("Pow", i)
        }
    });
    var Bu = sa({
        prelu_: function(e, t) {
            var n = {
                x: aa(e, "x", "prelu"),
                alpha: aa(t, "alpha", "prelu")
            };
            return Yr.runKernel(Nt, n)
        }
    });
    var Fu = sa({
    ...
    var Lu = Ou((function(e) {
      ...
      , Uu = Ou((function(e) {
        !function(t, n, r) {
            var a, i = 256, o = r.pow(i, 6), s = r.pow(2, 52), u = 2 * s, l = 255;
            function c(e, l, c) {
                var g = []
                  , m = p(d((l = 1 == l ? {
                    entropy: !0
                } : l || {}).entropy ? [e, v(n)] : null == e ? function() {
                    try {
                        var e;
                        return a && (e = a.randomBytes) ? e = e(i) : (e = new Uint8Array(i),
                        (t.crypto || t.msCrypto).getRandomValues(e)),
                        v(e)
                    } catch (e) {
                        var r = t.navigator
                          , o = r && r.plugins;
                        return [+new Date, t, o, t.screen, v(n)]
                    }
                }() : e, 3), g)
                  , y = new h(g)
                  , b = function() {
                    for (var e = y.g(6), t = o, n = 0; e < s; )
                        e = (e + n) * i,
                        t *= i,
                        n = y.g(1);
                    for (; e >= u; )
                ...
                )(b, m, "global"in l ? l.global : this == r, l.state)
            }
            function h(e) {
            ...
            e.exports) {
                ...
                r.seedrandom = c
        }("undefined" != typeof self ? self : Pu, [], Math)
    }
    ));
    Uu.alea = Lu,
    Uu.xor128 = zu,
    ...
    var Vu = Uu
      , Hu = function() {
        function e(e, t, n, r, a) {
            ...
            var i = a || Math.random();
            this.random = Vu.alea(i.toString())
        }
      ...
      , ju = function() {
        function e(e, t, n, r) {
            ...
            this.dtype = n;
            var a = r || Math.random();
            this.randu = Vu.alea(a.toString()),
            this.randn = new Hu(0,1,n,!1,this.randu()),
    ...
    var Zu = sa({
        randomGamma_: function(e, t, n, r, a) {
            ...
            for (var i = new ju(t,n,r,a), o = Qa(e, r), s = 0; s < o.values.length; s++)
    ...
    var Yu = sa({
        randomNormal_: function(e, t, n, r, a) {
            ...
            null != r && "bool" === r)
                throw new Error("Unsupported data type " + r);
            for (var i = new Hu(t,n,r,!1,a), o = Qa(e, r), s = 0; s < o.values.length; s++)
                o.values[s] = i.nextValue();
            return o.toTensor()
        }
    });
    var Xu = sa({
        randomUniform_: function(e, t, n, r, a) {
            ...
            void 0 === n && (n = 1),
            void 0 === r && (r = "float32");
            for (var i = Qa(e, r), o = new Ju(t,n,null,a), s = 0; s < i.values.length; s++)
    ...
    function Qu(e, t, n, r) {
        ...
        return Yr.runKernel(Tt, {}, a)
    }
    var $u = sa({
        real_: function(e) {
            var t = {
                input: aa(e, "input", "real")
            };
            return Yr.runKernel(Dt, t)
        }
    });
    var el = sa({
    ...
    var rl = sa({
        reverse_: function(e, t) {
            ...
            return Yr.runKernel(Lt, n, r)
        }
    });
    var al = sa({
        reverse1d_: function(e) {
            var t = aa(e, "x", "reverse");
            return p(1 === t.rank, (function() {
    ...
    var ul = sa({
        round_: function(e) {
            ...
            return Yr.runKernel(zt, t)
        }
    });
    var ll = sa({
        rsqrt_: function(e) {
            var t = {
                x: aa(e, "x", "rsqrt", "float32")
            };
            return Yr.runKernel(Kt, t)
        }
    });
    function cl(e, t) {
        if ((N(e) && "string" !== t || Array.isArray(e)) && "complex64" !== t)
            throw new Error("Error creating a new Scalar: value must be a primitive (number|boolean|string)");
        if ("string" === t && N(e) && !(e instanceof Uint8Array))
    ...
    var fl = sa({
        separableConv2d_: function(e, t, n, r, a, i, o) {
            void 0 === i && (i = [1, 1]),
            void 0 === o && (o = "NHWC");
            var s = aa(e, "x", "separableConv2d")
              , u = aa(t, "depthwiseFilter", "separableConv2d")
              , l = aa(n, "pointwiseFilter", "separableConv2d")
              , c = s
              , h = !1;
            if (3 === s.rank && (h = !0,
            c = Do(s, [1, s.shape[0], s.shape[1], s.shape[2]])),
            "NCHW" === o)
        ...
        return r(this, void 0, void 0, (function() {
            ...
            return a(this, (function(a) {
                ...
                case 2:
                    ...
                    h = 0; h < i.length; h++)
                        s.has(i[h]) || u++;
                    for (l = new Nr([u],n.dtype),
                    c = new Nr([u],"int32"),
                    h = 0,
                    f = 0; h < i.length; h++)
                        s.has(i[h]) || (l.values[f] = i[h],
                        c.values[f] = h,
                        f++);
    ...
    var pl = sa({
        sign_: function(e) {
            ...
            return Yr.runKernel(Ht, t)
        }
    });
    var vl = sa({
        sin_: function(e) {
            var t = {
                x: aa(e, "x", "sin", "float32")
            };
            return Yr.runKernel("Sin", t)
        }
    });
    var gl = sa({
        sinh_: function(e) {
            ...
            return Yr.runKernel(Vt, t)
        }
    });
    var ml = sa({
        slice1d_: function(e, t, n) {
            var r = aa(e, "x", "slice1d");
    ...
    var kl = sa({
        softmax_: function(e, t) {
            void 0 === t && (t = -1);
            var n = aa(e, "logits", "softmax", "float32");
            if (-1 === t && (t = n.rank - 1),
            t !== n.rank - 1)
            ...
            return Yr.runKernel(Qt, r, a)
        }
    });
    var xl = sa({
        fft_: function(e) {
            p("complex64" === e.dtype, (function() {
        ...
        irfft_: function(e) {
            ...
            if (n <= 2) {
                ...
                var i = [r, 2 * (n - 1)]
                  , o = Do($u(e), [r, n])
                  , s = Do(Bs(e), [r, n])
                  , u = rl(Po(o, [0, 1], [r, n - 2]), 1)
                  , l = ao(rl(Po(s, [0, 1], [r, n - 2]), 1), cl(-1))
                  , c = Fo([o, u], 1)
                  , h = Fo([s, l], 1);
                a = Do(ua(c, h), [i[0], i[1]]);
                t = El(a)
            ...
            3 === e.rank && 0 !== e.shape[0]) {
                var f = t
                  , d = e.shape[0];
                t = Do(t, [d, t.shape[0] / d, t.shape[1]]),
                f.dispose()
            }
            return t
        }
    ...
    var Al = sa({
        split_: function(e, t, n) {
            ...
            return Yr.runKernel(Xt, r, a)
        }
    });
    var _l = sa({
        rfft_: function(e, t) {
            p("float32" === e.dtype, (function() {
            ...
            var u = ms(n)
              ...
              , f = $u(c)
              , d = Bs(c)
              , v = Al(f, [h, r - h], f.shape.length - 1)
              , g = Al(d, [h, r - h], d.shape.length - 1)
              , m = n.shape.slice();
            return m[n.shape.length - 1] = h,
            Do(ua(v[0], g[0]), m)
        }
    });
    var Il = sa({
    ...
    var Nl = sa({
        squaredDifference_: function(e, t) {
            var n, r = aa(e, "a", "squaredDifference"), a = aa(t, "b", "squaredDifference");
            r = (n = o(Kr(r, a), 2))[0],
            a = n[1],
            ki(r.shape, a.shape);
            var i = {
            ...
            return Yr.runKernel(an, i, {})
        }
    });
    var Ml = sa({
        squeeze_: function(e, t) {
            var n = aa(e, "x", "squeeze");
            return Do(n, E(n.shape, t).newShape)
        }
    });
    var Tl = sa({
        stack_: function(e, t) {
            void 0 === t && (t = 0);
            var n = ia(e, "tensors", "stack", "string_or_numeric");
            p(n.length >= 1, (function() {
                return "Pass at least one tensor to tf.stack"
            }
            )),
            n.length > 0 && p(t <= n[0].rank, (function() {
                return "Axis must be <= rank of the tensor"
            }
            ));
            var r = n
    ...
    var Rl = sa({
        stridedSlice_: function(e, t, n, r, a, i, o, s, u) {
            ...
            void 0 === u && (u = 0);
            var l = {
                x: aa(e, "x", "stridedSlice", "string_or_numeric")
            }
              , c = {
                begin: t,
                end: n,
            ...
            return Yr.runKernel(on, l, c)
        }
    });
    var Bl = sa({
        tan_: function(e) {
            var t = {
                x: aa(e, "x", "tan", "float32")
            };
            return Yr.runKernel("Tan", t)
        }
    });
    function Fl(e, t) {
        g(e);
    ...
    var Ol = sa({
        truncatedNormal_: function(e, t, n, r, a) {
            ...
            for (var i = new Hu(t,n,r,!0,a), o = Qa(e, r), s = 0; s < o.values.length; s++)
                o.values[s] = i.nextValue();
            return o.toTensor()
        }
    });
    var Ll = sa({
        unique_: function(e, t) {
            void 0 === t && (t = 0);
            var n = aa(e, "x", "unique", "string_or_numeric");
            p(n.rank > 0, (function() {
    ...
    var zl = sa({
        unsortedSegmentSum_: function(e, t, n) {
            var r = aa(e, "x", "unsortedSegmentSum")
              , a = aa(t, "segmentIds", "unsortedSegmentSum", "int32");
            p(w(n), (function() {
            ...
            return Yr.runKernel(mn, i, o)
        }
    });
    var Kl = sa({
        unstack_: function(e, t) {
            void 0 === t && (t = 0);
            var n = aa(e, "x", "unstack", "string_or_numeric");
            p(t >= -n.shape.length && t < n.shape.length, (function() {
    ...
    var Wl = function(e) {
        return r(this, void 0, void 0, (function() {
            ...
            return a(this, (function(a) {
                switch (a.label) {
                case 0:
                    return [4, (t = aa(e, "condition", "whereAsync", "bool")).data()];
                case 1:
                    return n = a.sent(),
                    r = ql(t.shape, n),
                    e !== t && t.dispose(),
    ...
    var Gl = function(e, t, n) {
        return r(this, void 0, void 0, (function() {
            var r, i, o, s, u, l, c, h, f, d, g, m, y;
            return a(this, (function(a) {
                switch (a.label) {
                case 0:
                    for (r = aa(e, "tensor", "boolMask"),
                    i = aa(t, "mask", "boolMask", "bool"),
                    o = null == n ? 0 : n,
                    s = i.rank,
                    u = r.shape,
                    p(s > 0, (function() {
                    ...
                    v(u.slice(o, o + s), i.shape, "mask's shape must match the first K dimensions of tensor's shape,"),
                    l = 1,
                    c = o; c < o + s; c++)
                        l *= u[c];
                    return h = u.slice(0, o).concat([l], u.slice(o + s)),
                    f = Do(r, h),
                    d = Do(i, [-1]),
                    [4, Wl(d)];
                case 1:
    ...
    function Ul(e, t, n) {
        ...
        if (1 === e.rank || "number" == typeof n || Array.isArray(n) && 1 === n.length) {
            ...
            if (t === -1 / 0)
                return pu(io(e), n);
            if ("euclidean" === t || 2 === t)
                return Il(Xs(Ru(io(e), cl(2, "int32")), n));
            throw new Error("Error in norm: invalid ord value: " + t)
        }
        if (Array.isArray(n) && 2 === n.length) {
            if (1 === t)
                return Zs(Xs(io(e), n[0]), n[1] - 1);
            if (t === 1 / 0)
                return Zs(Xs(io(e), n[1]), n[0]);
            if (t === -1 / 0)
                return pu(Xs(io(e), n[1]), n[0]);
    ...
    var Hl = sa({
        movingAverage_: function(e, t, n, r, a) {
            void 0 === a && (a = !0);
            var i = aa(e, "v", "movingAverage")
              , o = aa(t, "x", "movingAverage")
              , s = aa(n, "decay", "movingAverage");
            qr(i, o),
            p(b(i.shape, o.shape), (function() {
    ...
    var jl = sa({
        scatterND_: function(e, t, n) {
            var r = aa(e, "indices", "scatterND", "int32")
              , a = aa(t, "updates", "scatterND");
            Di(a, r, n);
            var i = {
                indices: r,
                updates: a
            ...
            return Yr.runKernel(qt, i, o)
        }
    });
    var Jl = sa({
        sparseToDense_: function(e, t, n, r) {
            void 0 === r && (r = 0);
            var a = aa(e, "sparseIndices", "sparseToDense", "int32")
              , i = aa(t, "sparseValues", "sparseToDense")
              , o = aa(r, "defaultValue", "sparseToDense", i.dtype);
            !function(e, t, n, r) {
                if ("int32" !== e.dtype)
            ...
            return Yr.runKernel(rn, s, u)
        }
    });
    var Zl = sa({
        gatherND_: function(e, t) {
            var n = aa(t, "indices", "gatherND", "int32")
              , r = {
                params: aa(e, "x", "gatherND", "string_or_numeric"),
                indices: n
            };
            return Yr.runKernel(Je, r)
        }
    });
    var Yl = sa({
        dropout_: function(e, t, n, r) {
            var a = aa(e, "x", "dropout");
            if (p("float32" === a.dtype, (function() {
            ...
            0 === t)
                return e instanceof Dr ? a.clone() : a;
            var i = function(e, t) {
                if (null == t)
              ...
              , o = 1 - t
              , s = ro(Ms(to(Xu(i, 0, 1, "float32", r), o)), o);
            return ao(a, s)
        }
    });
    function Xl(e) {
    ...
    var $l = function(e, t, n) {
        return void 0 === n && (n = 1),
        r(this, void 0, void 0, (function() {
            var r, i, s, u, l, c, h, f, d, g, m, y, b, w;
            return a(this, (function(a) {
                switch (a.label) {
                case 0:
                    return r = aa(e, "predictions", "inTopK"),
                    i = aa(t, "targets", "inTopK"),
                    p(r.rank > 1, (function() {
                        return "inTopK() expects the predictions to be of rank 2 or higher, but got " + r.rank
                    }
                    )),
                    p(r.rank - 1 === i.rank, (function() {
                        return "predictions rank should be 1 larger than targets rank, but got predictions rank " + r.rank + " and targets rank " + i.rank
                    }
                    )),
                    v(r.shape.slice(0, r.shape.length - 1), i.shape, "predictions's shape should be align with the targets' shape, except the last dimension."),
    ...
    var ec = sa({
        conv2DBackpropFilter_: function(e, t, n, r, a, i, o) {
            void 0 === i && (i = "NHWC");
            var s = e;
            3 === e.rank && (s = Do(e, [1, e.shape[0], e.shape[1], e.shape[2]]));
            var u = t;
            3 === u.rank && (u = Do(t, [1, t.shape[0], t.shape[1], t.shape[2]])),
            p(4 === s.rank, (function() {
    ...
    var ic = sa({
        fusedConv2d_: function(e) {
            var t = e.x
              ...
              , g = e.leakyreluAlpha;
            if (d = d || "linear",
            !1 === ac(Yr.state.gradientDepth, d)) {
                var m = $o(t, n, r, a, s, l, c);
                return null != h && (m = to(m, h)),
                rc(m, d, v, g)
            }
            var y = aa(t, "x", "conv2d", "float32")
              , b = aa(n, "filter", "conv2d", "float32")
              , w = y
              , k = !1;
            3 === y.rank && (k = !0,
            w = Do(y, [1, y.shape[0], y.shape[1], y.shape[2]])),
            p(4 === w.rank, (function() {
            ...
            To("fused conv2d", a, c),
            p(w.shape[3] === b.shape[2], (function() {
                return "Error in conv2d: depth of input (" + w.shape[3] + ") must match input depth for filter " + b.shape[2] + "."
            }
            )),
            p(No(r, l), (function() {
                return "Error in conv2D: Either strides or dilations must be 1. Got strides " + r + " and dilations '" + l + "'"
            }
            )),
            p("NHWC" === s, (function() {
            ...
            var x, E, S = wo(w.shape, b.shape, r, l, a, c);
            null != h && (x = o(Kr(x = aa(h, "bias", "fused conv2d"), y), 1)[0],
            ki(S.outShape, x.shape)),
            null != v && (E = aa(v, "prelu weights", "fused conv2d"));
            var A = function(e, t) {
                var n = o(t, 4)
                  , i = n[0]
                  , s = n[1]
                ...
                var f = [ts(s.shape, h, i, r, a), ec(s, h, i.shape, r, a)];
                if (null != c) {
                    var v = nc(c, h);
                    f.push(v)
                }
            ...
            return null == h ? Us((function(e, t, n) {
                var r = Yr.runKernel(En, _, I);
                return n([t, e, r]),
                k && (r = Do(r, [r.shape[1], r.shape[2], r.shape[3]])),
                {
                    value: r,
                    gradFunc: A
                }
            }
            ))(w, b) : Us((function(e, t, n, r) {
                var a = Yr.runKernel(En, _, I);
                return r([t, e, a, n]),
                k && (a = Do(a, [a.shape[1], a.shape[2], a.shape[3]])),
                {
                    value: a,
                    gradFunc: A
                }
    ...
    var sc = sa({
        depthwiseConv2dNativeBackpropInput_: function(e, t, n, r, a, i, o) {
            ...
            var s = t
              , u = !1;
            3 === t.rank && (u = !0,
            s = Do(t, [1, t.shape[0], t.shape[1], t.shape[2]]));
            var l = {
                dy: s,
                filter: n
            }
              ...
              , h = Yr.runKernel(Fe, l, c);
            return u ? Do(h, [h.shape[1], h.shape[2], h.shape[3]]) : h
        }
    });
    var uc = {
        __proto__: null,
        ...
        depthwiseConv2d: sa({
            fusedDepthwiseConv2d_: function(e) {
                var t, n = e.x, r = e.filter, a = e.strides, i = e.pad, s = e.dataFormat, u = void 0 === s ? "NHWC" : s, l = e.dilations, c = void 0 === l ? [1, 1] : l, h = e.dimRoundingMode, f = e.bias, d = e.activation, v = void 0 === d ? "linear" : d, g = e.preluActivationWeights, m = e.leakyreluAlpha;
                if (!1 === ac(Yr.state.gradientDepth, v)) {
                    var y = fs(n, r, a, i, u, c, h);
                    return null != f && (y = to(y, f)),
                    rc(y, v, g, m)
                }
                var b = aa(n, "x", "depthwiseConv2d", "float32")
                  , w = aa(r, "filter", "depthwiseConv2d", "float32")
                  , k = b
                  , x = !1;
                3 === b.rank && (x = !0,
                k = Do(b, [1, b.shape[0], b.shape[1], b.shape[2]])),
                p(4 === k.rank, (function() {
                ...
                p(k.shape[3] === w.shape[2], (function() {
                ...
                To("fused depthwiseConv2d", i, h);
                var E, S, A = wo(k.shape, w.shape, a, c, i, h, !0);
                null != f && (t = o(Kr(E = aa(f, "bias", "fused conv2d"), b), 1),
                E = t[0],
                ki(A.outShape, E.shape)),
                null != g && (S = aa(g, "prelu weights", "fused depthwiseConv2d"));
                var _ = function(e, t) {
                    p(Io(c), (function() {
                    ...
                    var n = o(t, 4)
                      ...
                      , l = n[3]
                      , f = tc(e, u, v)
                      , d = sc(s.shape, f, r, a, i, c, h)
                      , g = oc(s, f, r.shape, a, i, c, h);
                    return null != l ? [d, g, nc(E, f)] : [d, g]
                }
                  , I = {
                    x: k,
                    filter: w,
                ...
                return null == f ? Us((function(e, t, n) {
                    var r = Yr.runKernel(Sn, I, N);
                    return n([t, e, r]),
                    x && (r = Do(r, [r.shape[1], r.shape[2], r.shape[3]])),
                    {
                        value: r,
                        gradFunc: _
                    }
                }
                ))(k, w) : Us((function(e, t, n, r) {
                    var a = Yr.runKernel(Sn, I, N);
                    return r([t, e, a, n]),
                    x && (a = Do(a, [a.shape[1], a.shape[2], a.shape[3]])),
                    {
                        value: a,
                        gradFunc: _
                    }
        ...
        matMul: sa({
            fusedMatMul_: function(e) {
                var t, n = e.a, r = e.b, a = e.transposeA, i = void 0 !== a && a, s = e.transposeB, u = void 0 !== s && s, l = e.bias, c = e.activation, h = void 0 === c ? "linear" : c, f = e.preluActivationWeights, d = e.leakyreluAlpha;
                if (!1 === ac(Yr.state.gradientDepth, h)) {
                    var v = vi(n, r, i, u);
                    return null != l && (v = to(v, l)),
                    rc(v, h, f, d)
                }
                var g = aa(n, "a", "fused matMul")
                  , m = aa(r, "b", "fused matMul");
                t = o(Kr(g, m), 2),
                g = t[0],
                m = t[1];
                var b = i ? g.shape[g.rank - 2] : g.shape[g.rank - 1]
                  , w = u ? m.shape[m.rank - 1] : m.shape[m.rank - 2]
                  , k = i ? g.shape[g.rank - 1] : g.shape[g.rank - 2]
                  , x = u ? m.shape[m.rank - 2] : m.shape[m.rank - 1]
                  , E = g.shape.slice(0, -2)
                  , S = m.shape.slice(0, -2)
                  , A = y(E)
                  , _ = y(S);
                p(b === w, (function() {
                    return "Error in fused matMul: inner shapes (" + b + ") and (" + w + ") of Tensors with shapes " + g.shape + " and " + m.shape + " and transposeA=" + i + " and transposeB=" + u + " must match."
                }
                ));
                var I, N, M = ki(g.shape.slice(0, -2), m.shape.slice(0, -2)).concat([k, x]), T = Do(g, i ? [A, b, k] : [A, k, b]), D = Do(m, u ? [_, x, w] : [_, w, x]);
                null != l && (I = o(Kr(I = aa(l, "bias", "fused matMul"), g), 1)[0],
                ki(M, I.shape)),
                null != f && (N = aa(f, "prelu weights", "fused matMul"));
                var R = function(e, t) {
                    var n, r, a = o(t, 4), s = a[0], c = a[1], f = a[2], d = a[3], p = tc(Do(e, f.shape), f, h);
                    return i || u ? !i && u ? (n = vi(p, c, !1, !1),
                    r = vi(p, s, !0, !1)) : i && !u ? (n = vi(c, p, !1, !0),
                    r = vi(s, p, !1, !1)) : (n = vi(c, p, !0, !0),
                    r = vi(p, s, !0, !0)) : (n = vi(p, c, !1, !0),
                    r = vi(s, p, !0, !1)),
                    null != l ? [n, r, nc(d, p)] : [n, r]
                }
                  , B = {
                    a: T,
                    b: D,
                ...
                return null == l ? Us((function(e, t, n) {
                    var r = Yr.runKernel(xn, B, F);
                    return n([e, t, r]),
                    {
                        value: Do(r, M),
                        gradFunc: R
                ...
                ))(T, D) : Us((function(e, t, n, r) {
                    var a = Yr.runKernel(xn, B, F);
                    return r([e, t, a, n]),
                    {
                        value: Do(a, M),
                        gradFunc: R
    ...
    var hc = sa({
        frame_: function(e, t, n, r, a) {
            ...
            if (r)
                for (; i < e.size; ) {
                    var s = i + t - e.size
                      , u = Fo([Po(e, i, t - s), Ns([s], a)]);
                    o.push(u),
                    i += n
                }
            return 0 === o.length ? Cl([], [0, t]) : Do(Fo(o), [o.length, t])
        }
    });
    var fc = sa({
    ...
    var dc = sa({
        cropAndResize_: function(e, t, n, r, a, i) {
            void 0 === a && (a = "bilinear"),
            void 0 === i && (i = 0);
            var o = aa(e, "image", "cropAndResize")
              , s = aa(t, "boxes", "cropAndResize", "float32")
              , u = aa(n, "boxInd", "cropAndResize", "int32")
              , l = s.shape[0];
            p(4 === o.rank, (function() {
            ...
            p(1 === u.rank && u.shape[0] === l, (function() {
            ...
            p(r[0] >= 1 && r[1] >= 1, (function() {
                return "cropSize must be atleast [1,1], but was " + r
            }
            )),
            p("bilinear" === a || "nearest" === a, (function() {
            ...
            return Yr.runKernel(Me, c, h)
        }
    });
    var pc = sa({
        flipLeftRight_: function(e) {
            var t = aa(e, "image", "flipLeftRight", "float32");
            p(4 === t.rank, (function() {
            ...
            return Yr.runKernel(Ge, n, {})
        }
    });
    var vc = sa({
        grayscaleToRGB_: function(e) {
            var t = aa(e, "image", "grayscaleToRGB")
              , n = t.rank - 1
              , r = t.shape[n];
            p(t.rank >= 2, (function() {
    ...
    var gc = sa({
        rotateWithOffset_: function(e, t, n, r) {
            void 0 === n && (n = 0),
            void 0 === r && (r = .5);
            var a = aa(e, "image", "rotateWithOffset", "float32");
            p(4 === a.rank, (function() {
    ...
    var yc = sa({
        nonMaxSuppression_: function(e, t, n, r, a) {
            ...
            var i = aa(e, "boxes", "nonMaxSuppression", "float32")
              , o = aa(t, "scores", "nonMaxSuppression", "float32")
              , s = mc(i, o, n, r, a)
              , u = {
    ...
    function kc(e, t, n, r, a) {
        return Sc(e, t, n, r, a, 0)
    }
    function xc(e, t, n, r, a, i) {
        return Sc(e, t, n, r, a, 0, !1, i, !0)
    }
    function Ec(e, t, n, r, a, i) {
        return Sc(e, t, n, r, a, i, !0)
    }
    function Sc(e, t, n, r, a, i, o, u, l) {
        void 0 === o && (o = !1),
        void 0 === u && (u = !1),
        void 0 === l && (l = !1);
        ...
        c.sort(Ic);
        for (var f = i > 0 ? -.5 / i : 0, d = [], p = []; d.length < n && c.length > 0; ) {
            var v = c.pop()
              , g = v.score
              , m = v.boxIndex
            ...
            for (var b = !1, w = d.length - 1; w >= y; --w) {
                ...
                if (v.score = v.score * _c(r, f, k),
                v.score <= a)
                    break
            }
            v.suppressBeginIndex = d.length,
            b || (v.score === g ? (d.push(m),
            p.push(v.score)) : v.score > a && bc(c, v, Ic))
        }
        var x = d.length
          , E = n - x;
        u && E > 0 && (d.push.apply(d, s(new Array(E).fill(0))),
        p.push.apply(p, s(new Array(E).fill(0))));
        var S = {
            selectedIndices: d
        };
    ...
    var Nc = function(e, t, n, i, o) {
        ...
        r(this, void 0, void 0, (function() {
            ...
            return a(this, (function(a) {
                switch (a.label) {
                case 0:
                    return r = aa(e, "boxes", "nonMaxSuppressionAsync"),
                    s = aa(t, "scores", "nonMaxSuppressionAsync"),
                    u = mc(r, s, n, i, o),
                    n = u.maxOutputSize,
                    i = u.iouThreshold,
                    o = u.scoreThreshold,
                ...
                case 1:
                    ...
                    c = l[0],
                    h = l[1],
                    f = kc(c, h, n, i, o).selectedIndices,
                    r !== e && r.dispose(),
                    s !== t && s.dispose(),
                    [2, Fl(f, "int32")]
                }
    ...
    var Mc = sa({
        nonMaxSuppressionWithScore_: function(e, t, n, r, a, i) {
            ...
            void 0 === a && (a = Number.NEGATIVE_INFINITY),
            void 0 === i && (i = 0);
            var o = aa(e, "boxes", "nonMaxSuppression")
              , s = aa(t, "scores", "nonMaxSuppression")
              , u = mc(o, s, n, r, a, i)
              , l = {
                boxes: o,
                scores: s
    ...
    var Tc = function(e, t, n, i, o, s) {
        return void 0 === i && (i = .5),
        void 0 === o && (o = Number.NEGATIVE_INFINITY),
        void 0 === s && (s = 0),
        r(this, void 0, void 0, (function() {
            var r, u, l, c, h, f, d, p, v;
            return a(this, (function(a) {
                switch (a.label) {
                case 0:
                    return r = aa(e, "boxes", "nonMaxSuppressionAsync"),
                    u = aa(t, "scores", "nonMaxSuppressionAsync"),
                    l = mc(r, u, n, i, o, s),
                    n = l.maxOutputSize,
                    i = l.iouThreshold,
                    o = l.scoreThreshold,
    ...
    var Rc = function(e, t, n, i, s, u) {
        return void 0 === i && (i = .5),
        void 0 === s && (s = Number.NEGATIVE_INFINITY),
        void 0 === u && (u = !1),
        r(this, void 0, void 0, (function() {
            var r, l, c, h, f, d, p, v, g, m, y, b;
            return a(this, (function(a) {
                switch (a.label) {
                case 0:
                    return r = aa(e, "boxes", "nonMaxSuppressionAsync"),
                    l = aa(t, "scores", "nonMaxSuppressionAsync"),
                    c = mc(r, l, n, i, s, null),
                    h = c.maxOutputSize,
                    f = c.iouThreshold,
                    d = c.scoreThreshold,
                    [4, Promise.all([r.data(), l.data()])];
                case 1:
                    return p = o.apply(void 0, [a.sent(), 2]),
                    v = p[0],
                    g = p[1],
                    m = xc(v, g, h, f, d, u),
                    y = m.selectedIndices,
                    ...
                    l !== t && l.dispose(),
                    [2, {
                        selectedIndices: Fl(y, "int32"),
                        validOutputs: cl(b, "int32")
                    }]
                }
            }
            ))
    ...
    var Bc = sa({
        resizeBilinear_: function(e, t, n, r) {
            void 0 === n && (n = !1),
            void 0 === r && (r = !1);
            var a = aa(e, "images", "resizeBilinear");
            p(3 === a.rank || 4 === a.rank, (function() {
            ...
            var i = a
              , s = !1;
            3 === a.rank && (s = !0,
            i = Do(a, [1, a.shape[0], a.shape[1], a.shape[2]])),
            o(t, 0);
            var u = {
                images: i
            }
    ...
    var Fc = sa({
        resizeNearestNeighbor_: function(e, t, n, r) {
            void 0 === n && (n = !1),
            void 0 === r && (r = !1);
            var a = aa(e, "images", "resizeNearestNeighbor");
            p(3 === a.rank || 4 === a.rank, (function() {
            ...
            p("float32" === a.dtype || "int32" === a.dtype, (function() {
    ...
    var Cc = sa({
        threshold_: function(e, t, n, r) {
            ...
            "otsu" === t && (f = function(e, t) {
                for (var n, r, a, i, o, s, u = Fl([-1]), l = Fl([0]), c = Fl([0]), h = 0; h < e.size - 1; h++) {
                    n = Po(e, 0, h + 1),
                    r = Po(e, h + 1),
                    o = ro(Xs(n), t),
                    s = ro(Xs(r), t);
                    var f = Xs(ao(n, Qu(0, n.size)));
                    a = ro(f, Xs(n));
                ...
                return u
            }(Uo($a(ul(l), "int32"), ca([]), 256), h));
            var m = n ? zs(l, f) : Ds(l, f);
            return $a(ao(m, 255), "int32")
        }
    });
    var Pc = sa({
        transform_: function(e, t, n, r, a, i) {
            ...
            void 0 === r && (r = "constant"),
            void 0 === a && (a = 0);
            var o = aa(e, "image", "transform", "float32")
              , s = aa(t, "transforms", "transform", "float32");
            p(4 === o.rank, (function() {
                return "Error in transform: image must be rank 4,but got rank " + o.rank + "."
            }
            )),
            p(2 === s.rank && (s.shape[0] === o.shape[0] || 1 === s.shape[0]) && 8 === s.shape[1], (function() {
                return "Error in transform: Input transform should be batch x 8 or 1 x 8"
            }
            )),
            p(null == i || 2 === i.length, (function() {
    ...
    var Oc = sa({
        bandPart_: function(e, t, n) {
            ...
            t < 0 && (t = s),
            n < 0 && (n = u);
            var l = Do(Qu(0, s, 1, "int32"), [-1, 1])
              , c = Qu(0, u, 1, "int32")
              , h = Ys(l, c)
              , f = ru(zs(h, cl(+t, "int32")), Rs(h, cl(-n, "int32")))
              , d = fu([s, u], r.dtype);
            return Do(Tl(Kl(Do(r, [-1, s, u])).map((function(e) {
                return gs(f, e, d)
            }
            ))), a)
        }
    ...
    var Lc = sa({
        gramSchmidt_: function(e) {
            ...
            if (Array.isArray(e)) {
                ...
                t = !0,
                e = Al(e, e.shape[0], 0).map((function(e) {
                    return Ml(e, [0])
                }
                ));
            ...
            var i = []
              , o = e
              , s = function(e) {
                i.push(Yr.tidy((function() {
                    var t = o[e];
                    if (e > 0)
                        for (var n = 0; n < e; ++n) {
                            var r = ao(Xs(ao(i[n], t)), i[n]);
                            t = Ys(t, r)
                        }
                    return ro(t, Vl(t, "euclidean"))
                }
                )))
            };
    ...
    function zc(e, t) {
        return void 0 === t && (t = !1),
        Yr.tidy((function() {
            p(2 === e.shape.length, (function() {
                return "qr2d() requires a 2D Tensor, but got a " + e.shape.length + "D Tensor."
            }
            ));
            for (var n = e.shape[0], r = e.shape[1], a = Is(n), i = ei(e), s = Cl([[1]], [1, 1]), u = ei(s), l = n >= r ? r : n, c = function(e) {
                var t, l = i, c = u, h = a;
                t = o(Yr.tidy((function() {
                    var t = Po(i, [e, e], [n - e, 1])
                      , o = Vl(t)
                      , l = Po(i, [e, e], [1, 1])
                      , c = gs(Ds(l, 0), Cl([[-1]]), Cl([[1]]))
                      , h = Ys(l, ao(c, o))
                      , f = ro(t, h);
                    u = 1 === f.shape[0] ? ei(s) : Fo([s, Po(f, [1, 0], [f.shape[0] - 1, f.shape[1]])], 0);
                    var d = Hs(ro(vi(c, h), o))
                      , p = Po(i, [e, 0], [n - e, r])
                      , v = ao(d, u)
                      , g = mi(u);
                    if (0 === e)
                        ...
                        var m = Ys(p, vi(v, vi(g, p)));
                        i = Fo([Po(i, [0, 0], [e, r]), m], 0)
                    }
                    var y = mi(v)
                      , b = Po(a, [0, e], [n, a.shape[1] - e]);
                    if (0 === e)
                        a = Ys(b, vi(vi(b, u), y));
                    else {
                        var w = Ys(b, vi(vi(b, u), y));
                        a = Fo([Po(a, [0, 0], [n, e]), w], 1)
                    }
                    return [u, i, a]
                }
                )), 3),
    ...
    var Kc, qc = sa({
        qr_: function(e, t) {
            ...
            var n = e.shape.slice(0, e.shape.length - 2).reduce((function(e, t) {
              ...
              , r = Kl(Do(e, [n, e.shape[e.shape.length - 2], e.shape[e.shape.length - 1]]), 0)
              , a = []
              , i = [];
            ...
            [Do(Tl(a, 0), e.shape), Do(Tl(i, 0), e.shape)]
        }
    });
    e.Reduction = void 0,
    ...
    var Wc = sa({
        computeWeightedLoss_: function(t, n, r) {
            ...
            var a = aa(t, "losses", "computeWeightedLoss")
              , i = null;
            null != n && (i = aa(n, "weights", "computeWeightedLoss"));
            var o = null == i ? a : ao(a, i);
            ...
            if (r === e.Reduction.MEAN) {
                ...
                var s = a.size / i.size
                  , u = ro(Xs(o), Xs(i));
                return s > 1 ? ro(u, cl(s)) : u
            }
            if (r === e.Reduction.SUM_BY_NONZERO_WEIGHTS) {
                if (null == i)
                    return ro(Xs(o), cl(a.size));
                var l = ao(i, du(a.shape))
                  , c = $a(Xs(xu(l, cl(0))), "float32");
                return ro(Xs(o), c)
            }
    ...
    var Gc = sa({
        absoluteDifference_: function(t, n, r, a) {
            ...
            var i = aa(t, "labels", "absoluteDifference")
              , o = aa(n, "predictions", "absoluteDifference")
              , s = null;
            null != r && (s = aa(r, "weights", "absoluteDifference")),
            v(i.shape, o.shape, "Error in absoluteDifference: ");
            var u = io(Ys(i, o));
            return Wc(u, s, a)
        }
    });
    var Uc = sa({
        cosineDistance_: function(t, n, r, a, i) {
            ...
            var o = aa(t, "labels", "cosineDistance")
              , s = aa(n, "predictions", "cosineDistance")
              , u = null;
            null != a && (u = aa(a, "weights", "cosineDistance")),
            v(o.shape, s.shape, "Error in cosineDistance: ");
            var l = cl(1)
              , c = Ys(l, Xs(ao(o, s), r, !0));
            return Wc(c, u, i)
        }
    });
    var Vc = sa({
        hingeLoss_: function(t, n, r, a) {
            void 0 === a && (a = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
            var i = aa(t, "labels", "hingeLoss")
              , o = aa(n, "predictions", "hingeLoss")
              , s = null;
            null != r && (s = aa(r, "weights", "hingeLoss")),
            v(i.shape, o.shape, "Error in hingeLoss: ");
            var u = cl(1);
            i = Ys(ao(cl(2), i), u);
            var l = tl(Ys(u, ao(i, o)));
            return Wc(l, s, a)
        }
    });
    var Hc = sa({
        huberLoss_: function(t, n, r, a, i) {
            void 0 === a && (a = 1),
            void 0 === i && (i = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
            var o = aa(t, "labels", "huberLoss")
              , s = aa(n, "predictions", "huberLoss")
              , u = null;
            null != r && (u = aa(r, "weights", "huberLoss")),
            v(o.shape, s.shape, "Error in huberLoss: ");
            var l = cl(a)
              , c = io(Ys(s, o))
              , h = vu(c, l)
              , f = Ys(c, h)
              , d = to(ao(cl(.5), yu(h)), ao(l, f));
            return Wc(d, u, i)
        }
    });
    var jc = sa({
        logLoss_: function(t, n, r, a, i) {
            void 0 === a && (a = 1e-7),
            void 0 === i && (i = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
            var o = aa(t, "labels", "logLoss")
              , s = aa(n, "predictions", "logLoss")
              , u = null;
            null != r && (u = aa(r, "weights", "logLoss")),
            v(o.shape, s.shape, "Error in logLoss: ");
            var l = cl(1)
              , c = cl(a)
              , h = Hs(ao(o, qs(to(s, c))))
              , f = ao(Ys(l, o), qs(to(Ys(l, s), c)))
              , d = Ys(h, f);
            return Wc(d, u, i)
        }
    });
    var Jc = sa({
        meanSquaredError_: function(t, n, r, a) {
            void 0 === a && (a = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
            var i = aa(t, "labels", "meanSquaredError")
              , o = aa(n, "predictions", "meanSquaredError")
              , s = null;
            null != r && (s = aa(r, "weights", "meanSquaredError")),
            v(i.shape, o.shape, "Error in meanSquaredError: ");
            var u = Nl(i, o);
            return Wc(u, s, a)
        }
    });
    var Zc = sa({
        sigmoidCrossEntropy_: function(t, n, r, a, i) {
            void 0 === a && (a = 0),
            void 0 === i && (i = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
            var o = aa(t, "multiClassLabels", "sigmoidCrossEntropy")
              , s = aa(n, "logits", "sigmoidCrossEntropy")
              , u = null;
            if (null != r && (u = aa(r, "weights", "sigmoidCrossEntropy")),
            v(o.shape, s.shape, "Error in sigmoidCrossEntropy: "),
            a > 0) {
                var l = cl(a)
                  , c = cl(1)
                  , h = cl(.5);
                o = to(ao(o, Ys(c, l)), ao(h, l))
            }
            var f = function(e, t) {
                var n = aa(e, "labels", "sigmoidCrossEntropyWithLogits")
    ...
    var Yc = sa({
        softmaxCrossEntropy_: function(t, n, r, a, i) {
            void 0 === a && (a = 0),
            void 0 === i && (i = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
            var s = aa(t, "onehotLabels", "softmaxCrossEntropy")
              , u = aa(n, "logits", "softmaxCrossEntropy")
              , l = null;
            if (null != r && (l = aa(r, "weights", "softmaxCrossEntropy")),
            v(s.shape, u.shape, "Error in softmaxCrossEntropy: "),
            a > 0) {
                var c = cl(a)
                  , h = cl(1)
                  , f = cl(s.shape[1]);
                s = to(ao(s, Ys(h, c)), ro(c, f))
            }
                    ...
                    return {
                        ...
                        gradFunc: function(e, t) {
                            var r = o(t, 2)
                              ...
                              , i = r[1]
                              , s = tu(e.shape, [n]);
                            return [ao(Do(e, s), Ys($a(a, "float32"), Es(i))), ao(Do(e, s), Ys(Es(i), $a(a, "float32")))]
                        }
                    }
                }
                ))(e, t)
    ...
    var Xc = sa({
        sparseFillEmptyRows_: function(e, t, n, r) {
            var a = aa(e, "indices", "sparseFillEmptyRows", "int32")
              , i = aa(t, "values", "sparseFillEmptyRows")
              , o = aa(n, "denseShape", "sparseFillEmptyRows", "int32")
              , s = aa(r, "defaultValue", "sparseFillEmptyRows", i.dtype);
            if (2 !== a.rank)
    ...
    var Qc = sa({
        sparseReshape_: function(e, t, n) {
            var r = aa(e, "inputIndices", "sparseReshape", "int32")
              , a = aa(t, "inputShape", "sparseReshape", "int32")
              , i = aa(n, "newShape", "sparseReshape", "int32");
            if (2 !== r.rank)
    ...
    var $c = sa({
        sparseSegmentMean_: function(e, t, n) {
            var r = aa(e, "data", "sparseSegmentMean")
              , a = aa(t, "indices", "sparseSegmentMean", "int32")
              , i = aa(n, "segmentIds", "sparseSegmentMean", "int32");
            if (r.rank < 1)
            ...
            return Yr.runKernel(tn, o)
        }
    });
    var eh = sa({
        sparseSegmentSum_: function(e, t, n) {
            var r = aa(e, "data", "sparseSegmentSum")
              , a = aa(t, "indices", "sparseSegmentSum", "int32")
              , i = aa(n, "segmentIds", "sparseSegmentSum", "int32");
            if (r.rank < 1)
                throw new Error("Data should be at least 1 dimensional but received scalar");
            if (1 !== a.rank)
                throw new Error("Indices should be Tensor1D but received shape\n         " + a.shape);
    ...
    var nh = sa({
        stringSplit_: function(e, t, n) {
            void 0 === n && (n = !0);
            var r = aa(e, "input", "stringSplit", "string")
              , a = aa(t, "delimiter", "stringSplit", "string");
            if (1 !== r.rank)
    ...
    var rh = sa({
        stringToHashBucketFast_: function(e, t) {
            var n = aa(e, "input", "stringToHashBucketFast", "string")
              , r = {
                numBuckets: t
            };
            if (t <= 0)
      ...
      , oh = {
        ...
        nonMaxSuppressionWithScore: Mc,
        nonMaxSuppressionWithScoreAsync: Tc,
        nonMaxSuppressionPadded: Dc,
        nonMaxSuppressionPaddedAsync: Rc,
        threshold: Cc,
        transform: Pc
    }
      , sh = {
      ...
      , hh = function(e) {
        ...
        ,
        t.prototype.dispose = function() {
            null != this.iterations_ && $i(this.iterations_)
        }
        ,
        t.prototype.saveIterations = function() {
            return r(this, void 0, void 0, (function() {
                return a(this, (function(e) {
                    ...
                    [2, {
                        name: "iter",
                        tensor: cl(this.iterations_, "int32")
                    }]
                }
                ))
            }
    ...
    Object.defineProperty(hh, Symbol.hasInstance, {
        value: function(e) {
    ...
    var fh = function(e) {
        function t(t, n, r) {
            ...
            null == r && (a.epsilon = Yr.backend.epsilon()),
            a
        }
        return n(t, e),
        t.prototype.applyGradients = function(e) {
            ...
            (Array.isArray(e) ? e.map((function(e) {
                ...
                if (null != i) {
                    ...
                    Qi((function() {
                        var e = to(ao(o, t.rho), ao(yu(i), 1 - t.rho))
                          , n = ao(ro(Il(to(s, t.epsilon)), Il(to(o, t.epsilon))), i)
                          , r = to(ao(s, t.rho), ao(yu(n), 1 - t.rho));
                        o.assign(e),
                        s.assign(r);
                        var u = to(ao(n, -t.learningRate), a);
                        a.assign(u)
                    }
                    ))
                }
        ...
        ,
        t.prototype.dispose = function() {
            null != this.accumulatedUpdates && ($i(this.accumulatedGrads.map((function(e) {
                return e.variable
            }
            ))),
            $i(this.accumulatedUpdates.map((function(e) {
                return e.variable
            }
            ))))
        }
        ...
        t.prototype.getWeights = function() {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(t) {
                    switch (t.label) {
                    case 0:
                        return e = s(this.accumulatedGrads, this.accumulatedUpdates),
    ...
    var dh = function(e) {
            ...
            (Array.isArray(e) ? e.map((function(e) {
                ...
                if (null != i) {
                    ...
                    Qi((function() {
                        var e = to(o, yu(i));
                        o.assign(e);
                        var n = to(ao(ro(i, Il(to(e, Yr.backend.epsilon()))), -t.learningRate), a);
                        a.assign(n)
                    }
                    ))
                }
        ...
        ,
        t.prototype.dispose = function() {
            null != this.accumulatedGrads && $i(this.accumulatedGrads.map((function(e) {
                return e.variable
            }
            )))
        }
    ...
    var ph = function(e) {
        function t(t, n, r, a) {
            ...
            Qi((function() {
                i.accBeta1 = cl(n).variable(),
                i.accBeta2 = cl(r).variable()
            }
            )),
            null == a && (i.epsilon = Yr.backend.epsilon()),
            i
        }
        return n(t, e),
        t.prototype.applyGradients = function(e) {
            ...
            Qi((function() {
                var r = Ys(1, t.accBeta1)
                  , a = Ys(1, t.accBeta2);
                n.forEach((function(n, i) {
                    var o = Yr.registeredVariables[n];
                    null == t.accumulatedFirstMoment[i] && (t.accumulatedFirstMoment[i] = {
                        originalName: n + "/m",
                        variable: Qi((function() {
                            return ms(o).variable(false)
                        }
                        ))
                    }),
                    ...
                    if (null != s) {
                        var u = t.accumulatedFirstMoment[i].variable
                          ...
                          , c = to(ao(u, t.beta1), ao(s, 1 - t.beta1))
                          , h = to(ao(l, t.beta2), ao(yu(s), 1 - t.beta2))
                          , f = ro(c, r)
                          , d = ro(h, a);
                        u.assign(c),
                        l.assign(h);
                        var p = to(ao(ro(f, to(Il(d), t.epsilon)), -t.learningRate), o);
                        o.assign(p)
                    }
                }
                )),
                t.accBeta1.assign(ao(t.accBeta1, t.beta1)),
                t.accBeta2.assign(ao(t.accBeta2, t.beta2))
            }
            )),
            this.incrementIterations()
        }
        ...
        t.prototype.dispose = function() {
            ...
            null != this.accumulatedFirstMoment && $i(this.accumulatedFirstMoment.map((function(e) {
                return e.variable
            }
            ))),
            null != this.accumulatedSecondMoment && $i(this.accumulatedSecondMoment.map((function(e) {
                return e.variable
            }
            )))
        }
        ...
        t.prototype.getWeights = function() {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(t) {
                    switch (t.label) {
                    case 0:
                        return e = s(this.accumulatedFirstMoment, this.accumulatedSecondMoment),
                        [4, this.saveIterations()];
                    case 1:
                        return [2, [t.sent()].concat(e.map((function(e) {
                            return {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(r) {
                    ...
                    case 1:
                        return e = r.sent(),
                        Qi((function() {
                            n.accBeta1.assign(Ru(n.beta1, n.iterations_ + 1)),
                            n.accBeta2.assign(Ru(n.beta2, n.iterations_ + 1))
                        }
                        )),
                        t = e.length / 2,
                        !1,
    ...
    var vh = function(e) {
        function t(t, n, r, a, i) {
            ...
            Qi((function() {
                o.iteration = cl(0).variable(),
                o.accBeta1 = cl(n).variable()
            }
            )),
            null == a && (o.epsilon = Yr.backend.epsilon()),
            o
        }
        return n(t, e),
        t.prototype.applyGradients = function(e) {
            ...
            Qi((function() {
                var r = Ys(1, t.accBeta1)
                  , a = ro(-t.learningRate, to(ao(t.iteration, t.decay), 1));
                n.forEach((function(n, i) {
                    var o = Yr.registeredVariables[n];
                    null == t.accumulatedFirstMoment[i] && (t.accumulatedFirstMoment[i] = {
                        originalName: n + "/m",
                        variable: ms(o).variable(false)
                    }),
                    ...
                    if (null != s) {
                        ...
                        u.assign(c),
                        l.assign(d);
                        var p = to(ao(ro(a, r), ro(c, to(d, t.epsilon))), o);
                        o.assign(p)
                    }
                }
                )),
        ...
        t.prototype.dispose = function() {
            ...
            null != this.accumulatedWeightedInfNorm && $i(this.accumulatedWeightedInfNorm.map((function(e) {
                return e.variable
            }
            )))
        }
    ...
    var gh = function(e) {
        ...
        t.prototype.applyGradients = function(e) {
            ...
            (Array.isArray(e) ? e.map((function(e) {
                ...
                if (null != a) {
                    var i = Yr.registeredVariables[n];
                    Qi((function() {
                        var e = to(ao(t.c, a), i);
                        i.assign(e)
                    }
    ...
    var mh = function(e) {
        ...
        t.prototype.applyGradients = function(e) {
            ...
            (Array.isArray(e) ? e.map((function(e) {
                ...
                null != o && Qi((function() {
                    var e, n = to(ao(t.m, i), o);
                    e = t.useNesterov ? to(ao(t.c, to(o, ao(n, t.m))), a) : to(ao(t.c, n), a),
                    i.assign(n),
                    a.assign(e)
                }
                ))
        ...
        t.prototype.dispose = function() {
            this.m.dispose(),
            null != this.accumulations && $i(this.accumulations.map((function(e) {
                return e.variable
            }
            )))
        }
    ...
    var yh = function(e) {
        ...
        t.prototype.applyGradients = function(e) {
            ...
            (Array.isArray(e) ? e.map((function(e) {
                ...
                if (null != o) {
                    ...
                    Qi((function() {
                        var e = to(ao(s, t.decay), ao(yu(o), 1 - t.decay));
                        if (t.centered) {
                            var n = t.accumulatedMeanGrads[r].variable
                              , i = to(ao(n, t.decay), ao(o, 1 - t.decay))
                              , l = ro(ao(o, t.learningRate), Il(Ys(e, to(yu(i), t.epsilon))))
                              , c = to(ao(u, t.momentum), l);
                            s.assign(e),
                            n.assign(i),
                            u.assign(c);
                            var h = Ys(a, c);
                            ...
                            var f = to(ao(s, t.decay), ao(yu(o), 1 - t.decay));
                            c = to(ao(u, t.momentum), ro(ao(o, t.learningRate), Il(to(f, t.epsilon))));
                            s.assign(f),
                            u.assign(c);
                            h = Ys(a, c);
                            a.assign(h)
        ...
        ,
        t.prototype.dispose = function() {
            null != this.accumulatedMeanSquares && $i(this.accumulatedMeanSquares.map((function(e) {
                return e.variable
            }
            ))),
            null != this.accumulatedMeanGrads && this.centered && $i(this.accumulatedMeanGrads.map((function(e) {
                return e.variable
            }
            ))),
            null != this.accumulatedMoments && $i(this.accumulatedMoments.map((function(e) {
                return e.variable
            }
            )))
        }
        ...
        t.prototype.getWeights = function() {
            return r(this, void 0, void 0, (function() {
                ...
                return a(this, (function(t) {
                    switch (t.label) {
                    case 0:
                        return e = s(this.accumulatedMeanSquares, this.accumulatedMoments),
                        this.centered && e.push.apply(e, s(this.accumulatedMeanGrads)),
                        [4, this.saveIterations()];
                    case 1:
                        return [2, [t.sent()].concat(e.map((function(e) {
                            return {
    ...
    var bh = function() {
      ...
      , wh = {
        sgd: bh.sgd,
        momentum: bh.momentum,
        adadelta: bh.adadelta,
        adagrad: bh.adagrad,
        rmsprop: bh.rmsprop,
        adamax: bh.adamax,
        adam: bh.adam
    }
      , kh = "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" != typeof setImmediate ? setImmediate : function(e) {
        return e()
    }
    ;
    var xh = "->"
    ...
    var Ah = {
        ...
        segment_util: {
            ...
            segOpComputeOptimalWindowSize: function(e, t) {
                var n, r = !1;
                for (e <= 30 ? (n = e,
                r = !0) : n = P(e, Math.floor(Math.sqrt(e))); !r; )
        ...
        computeDilation2DInfo: function(e, t, n, r, a, i) {
            ...
            wo(e, s(t, [e[3]]), n, i, r, null, null, Mo(a))
        },
        computePool2DInfo: bo,
        computePool3DInfo: function(e, t, n, r, a, i, s) {
            void 0 === s && (s = "NDHWC");
            var u, l, c = o(So(t), 3), h = c[0], f = c[1], d = c[2];
            if ("NDHWC" === s)
                l = "channelsLast",
                u = [h, f, d, e[4], e[4]];
            else {
            ...
            return ko(e, u, n, r, a, !1, l, i)
        },
        computeConv2DInfo: wo,
        computeConv3DInfo: ko,
        computeDefaultPad: xo,
        tupleValuesAreOne: Io,
        eitherStridesOrDilationsAreOne: No,
        convertConv2DDataFormat: Mo,
        checkPadOnDimRoundingMode: To,
        ...
        log: function() {
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            Z().getBool("IS_TEST") || Z().getBool("PROD") || console.log.apply(console, s(e))
        },
        ...
        decodeEinsumEquation: function(e, t) {
            var n = ((e = e.replace(/\s/g, "")).length - e.replace(Eh, "").length) / xh.length;
            if (n < 1)
                throw new Error("Equations without an arrow are not supported.");
            if (n > 1)
                throw new Error('Equation must contain exactly one arrow ("->").');
            var r = o(e.split(xh), 2)
              , a = r[0]
              , i = r[1];
            p(-1 === a.indexOf("..."), (function() {
            ...
            var s = a.split(",")
              , u = s.length;
            if (t !== u)
                throw new Error("Expected " + u + " input tensors, received " + t);
            if (u > 2)
            ...
            for (h = 0; h < a.length; ++h) {
                var f = a[h];
                -1 === l.indexOf(f) && "," !== f && l.push(f)
            }
            var d = new Array(s.length);
            for (h = 0; h < u; ++h) {
                if (new Set(s[h].split("")).size !== s[h].length)
                    throw new Error("Found duplicate axes in input component " + s[h] + ". Support for duplicate axes in input is not implemented yet.");
                d[h] = [];
                for (var v = 0; v < s[h].length; ++v)
                    d[h].push(l.indexOf(s[h][v]))
            }
            var g = l.length
              , m = [];
            for (h = i.length; h < g; ++h)
                m.push(h);
            return {
                allDims: l,
                summedDims: m,
        ...
        checkEinsumDimSizes: function(e, t, n) {
            for (var r = new Array(e), a = function(e) {
                for (var a = n[e].shape, i = function(n) {
                    void 0 === r[t[e][n]] ? r[t[e][n]] = a[n] : p(r[t[e][n]] === a[n], (function() {
        ...
        getEinsumComputePath: function(e, t) {
            ...
            for (u = 0; u < o.length; ++u) {
                ...
                try {
                    for (var h = (n = void 0,
                    i(c)), f = h.next(); !f.done; f = h.next()) {
                        var d = f.value;
                        -1 === l.indexOf(d) && (s[u].push(d),
                        l.push(d))
                    }
                } catch (e) {
                    n = {
        ...
        prepareSplitSize: function(e, t, n) {
            ...
            if ("number" == typeof t)
                ...
                p(e.shape[n] === t.reduce((function(e, t) {
                    return e + t
                }
                )), (function() {
        ...
        getSparseReshapeInputOutputMultipleErrorMessage: function(e, t) {
            return "Input to reshape is a SparseTensor with " + y(e) + "\n  dense values, but the requested shape requires a multiple of " + y(t) + ". inputShape=" + e + " outputShape= " + t
        },
        getSparseReshapeInputOutputMismatchErrorMessage: function(e, t) {
            return "Input to reshape is a tensor with " + y(e) + " dense values, but the requested shape has " + y(t) + ". inputShape=" + e + " outputShape=" + t
        },
      ...
      , _h = {
        __proto__: null,
        nonMaxSuppressionV3Impl: kc,
        nonMaxSuppressionV4Impl: xc,
        nonMaxSuppressionV5Impl: Ec,
        whereImpl: ql
    };
    e.Abs = "Abs",
    e.Acos = Q,
    e.Acosh = $,
    e.AdadeltaOptimizer = fh,
    e.AdagradOptimizer = dh,
    e.AdamOptimizer = ph,
    e.AdamaxOptimizer = vh,
    e.Add = ee,
    e.AddN = te,
    e.All = "All",
    e.Any = "Any",
    ...
    e.Concat = we,
    e.Conv2D = ke,
    e.Conv2DBackpropFilter = xe,
    e.Conv2DBackpropInput = Ee,
    e.Conv3D = Se,
    e.Conv3DBackpropFilterV2 = "Conv3DBackpropFilterV2",
    e.Conv3DBackpropInputV2 = Ae,
    e.Cos = "Cos",
    e.Cosh = _e,
    e.CropAndResize = Me,
    e.Cumprod = Ie,
    ...
    e.DenseBincount = Te,
    e.DepthToSpace = De,
    e.DepthwiseConv2dNative = Re,
    e.DepthwiseConv2dNativeBackpropFilter = Be,
    e.DepthwiseConv2dNativeBackpropInput = Fe,
    e.Diag = Ce,
    e.Dilation2D = Pe,
    ...
    e.MirrorPad = mt,
    e.Mod = "Mod",
    e.MomentumOptimizer = mh,
    e.Multinomial = yt,
    e.Multiply = bt,
    e.Neg = "Neg",
    e.NonMaxSuppressionV3 = kt,
    e.NonMaxSuppressionV4 = xt,
    e.NonMaxSuppressionV5 = Et,
    e.NotEqual = wt,
    e.OP_SCOPE_SUFFIX = oa,
    e.OneHot = At,
    e.OnesLike = St,
    e.Optimizer = hh,
    e.OptimizerConstructors = bh,
    e.Pack = _t,
    e.PadV2 = It,
    e.Pool = "Pool",
    e.Pow = "Pow",
    ...
    e.Softplus = Jt,
    e.SpaceToBatchND = Yt,
    e.SparseFillEmptyRows = $t,
    e.SparseReshape = en,
    e.SparseSegmentMean = tn,
    e.SparseSegmentSum = nn,
    e.SparseToDense = rn,
    e.SplitV = Xt,
    e.Sqrt = Zt,
    e.Square = "Square",
    e.SquaredDifference = an,
    e.Step = bn,
    e.StridedSlice = on,
    e.StringNGrams = sn,
    e.StringSplit = un,
    ...
    e.conv1d = es,
    e.conv2d = $o,
    e.conv2dTranspose = ns,
    e.conv3d = rs,
    e.conv3dTranspose = is,
    ...
    e.deprecationWarn = function(e) {
        Z().getBool("DEPRECATION_WARNINGS_ENABLED") && console.warn(e + " You can disable deprecation warnings with tf.disableDeprecationWarnings().")
    }
    ,
    e.depthToSpace = hs,
    e.depthwiseConv2d = fs,
    e.device_util = $r,
    e.diag = ds,
    e.dilation2d = ps,
    ...
    e.findBackend = function(e) {
        return Yr.findBackend(e)
    }
    ,
    e.findBackendFactory = function(e) {
        return Yr.findBackendFactory(e)
    }
    ,
    e.floor = Ms,
    e.floorDiv = no,
    ...
    e.getBackend = function() {
        return Yr.backendName
    }
    ,
    e.getGradient = Mn,
    e.getKernel = Nn,
    e.getKernelsForBackend = Tn,
    e.grad = function(e) {
        return p(C(e), (function() {
        ...
        function(t, n) {
            var r = aa(t, "x", "tf.grad", "string_or_numeric")
              , a = null != n ? aa(n, "dy", "tf.grad") : null;
            return Yr.tidy((function() {
                var t = Yr.gradients((function() {
                    return e(r)
                }
                ), [r], a)
                  , n = t.value
                  , i = t.grads;
                return null != a && v(n.shape, a.shape, "The shape of dy passed in grad(f)(x, dy) must match the shape returned by f(x)"),
                Vs(i),
                i[0]
            }
            ))
    ...
    e.grads = function(e) {
        ...
        function(t, n) {
            ...
            var r = ia(t, "args", "tf.grads", "string_or_numeric")
              , a = null != n ? aa(n, "dy", "tf.grads") : null;
            return Yr.tidy((function() {
                var t = Yr.gradients((function() {
                    return e.apply(void 0, s(r))
                }
                ), r, a)
                  , n = t.value
                  , i = t.grads;
                return null != a && v(n.shape, a.shape, "The shape of dy passed in grads(f)([x1,...], dy) must match the shape returned by f([x1,...])"),
                Vs(i),
                i
            }
            ))
    ...
    e.meshgrid = function(e, t, n) {
        ...
        if (void 0 === e)
            return [];
        var i = aa(e, "x", "meshgrid", e instanceof Dr ? e.dtype : "float32");
        if (void 0 === t)
            return [i];
        var o = aa(t, "y", "meshgrid", t instanceof Dr ? t.dtype : "float32")
          , s = y(i.shape)
          , u = y(o.shape);
        return "xy" === a ? (i = Do(i, [1, -1]),
        o = Do(o, [-1, 1]),
        [vi(du([u, 1], i.dtype), i), vi(o, du([1, s], o.dtype))]) : (i = Do(i, [-1, 1]),
        o = Do(o, [1, -1]),
        [vi(i, du([1, u], i.dtype)), vi(du([s, 1], o.dtype), o)])
    }
    ,
    e.min = pu,
    e.minimum = vu,
    ...
    e.registerBackend = function(e, t, n) {
        return void 0 === n && (n = 1),
        Yr.registerBackend(e, t, n)
    }
    ,
    e.registerGradient = function(e) {
        var t = e.kernelName;
        In.has(t) && Z().getBool("DEBUG") && An("Overriding the gradient for '" + t + "'"),
        In.set(t, e)
    }
    ,
    e.registerKernel = Dn,
    ...
    e.scatter_util = Bi,
    e.selu = hl,
    e.separableConv2d = fl,
    e.serialization = ji,
    e.setBackend = function(e) {
        return Yr.setBackend(e)
    }
    ,
    ...
    e.valueAndGrad = function(e) {
        ...
        function(t, n) {
            p(t instanceof Dr, (function() {
                return "The x passed in valueAndGrad(f)(x) must be a tensor"
            }
            )),
            p(null == n || n instanceof Dr, (function() {
                return "The dy passed in valueAndGrad(f)(x, dy) must be a tensor"
            }
            ));
            var r = Yr.gradients((function() {
                return e(t)
            }
            ), [t], n)
              , a = r.grads
    ...
    e.valueAndGrads = function(e) {
        ...
        function(t, n) {
            p(Array.isArray(t) && t.every((function(e) {
                return e instanceof Dr
            }
            )), (function() {
            ...
            return null != n && v(r.value.shape, n.shape, "The shape of dy passed in valueAndGrads(f)([x1,...], dy) must match the shape returned by f([x1,...])"),
            Vs(r.grads),
            r
        }
    }
    ...
    e.variable = function(e, t, n, r) {
        return void 0 === t && (t = !0),
        Yr.makeVariable(e, t, n, r)
    }
    ,
    e.variableGrads = Gs,
    e.version_core = "3.16.0",
    e.where = gs,
    e.whereAsync = Wl,
    e.zeros = fu,
    e.zerosLike = ms,
